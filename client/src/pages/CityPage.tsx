...
const cityData = {
  newcastle: {
    ...
    heroTitle: 'Professional Cleaning Services in Newcastle — including Jesmond, Heaton, Gosforth & city centre',
    ...
    areas: ['Jesmond', 'Heaton', 'Gosforth', 'City Centre', 'Sandyford', 'Quayside'],
    galleryItems: [
  ...
  leeds: {
    ...
    heroTitle: 'Professional Cleaning Services in Leeds — Headingley, Hyde Park, Burley & suburbs',
    heroSubhead: 'End of Tenancy, Office & Deep Cleans — Instant Quotes in 60 Seconds.',
    rating: 'Rated 4.9/5 by local tenants & landlords',
    proofText: 'DBS-checked professional cleaners | Fully insured & COSHH-compliant | Deposit-Back Guarantee or free re-clean within 48 hours',
    ...
    pricingText: 'We believe in clear, upfront pricing',
    galleryIntro: 'See the difference our expert cleaners deliver:',
    areas: ['Headingley', 'Hyde Park', 'Burley', 'Kirkstall', 'City Centre', 'Roundhay', 'Chapel Allerton'],
    galleryItems: [
  ...
  york: {
    ...
    heroTitle: 'Professional Cleaning Services in York — Heslington, Clifton, York city centre',
    heroSubhead: 'End of Tenancy, Office & Deep Cleans — Instant Quotes in 60 Seconds.',
    rating: 'Rated 4.9/5 by local tenants & landlords',
    proofText: 'DBS-checked professional cleaners | Fully insured & COSHH-compliant | Deposit-Back Guarantee or free re-clean within 48 hours',
    ...
    pricingText: 'We believe in clear, upfront pricing',
    galleryIntro: 'See the difference our expert cleaners deliver:',
    areas: ['Heslington', 'Clifton', 'York city centre', 'Acomb', 'Fulford', 'Bishopthorpe'],
    galleryItems: [
  ...
  sunderland: {
    ...
    heroTitle: 'Professional Cleaning Services in Sunderland — Ashbrooke, city centre & University areas',
    heroSubhead: 'End of Tenancy, Office & Deep Cleans — Instant Quotes in 60 Seconds.',
    rating: 'Rated 4.9/5 by local tenants & landlords',
    proofText: 'DBS-checked professional cleaners | Fully insured & COSHH-compliant | Deposit-Back Guarantee or free re-clean within 48 hours',
    ...
    pricingText: 'We believe in clear, upfront pricing',
    galleryIntro: 'See the difference our expert cleaners deliver:',
    areas: ['Ashbrooke', 'City Centre', 'University areas', 'Roker', 'Southwick', 'Hendon'],
    galleryItems: [
  ...
  middlesbrough: {
    ...
    heroTitle: 'Professional Cleaning Services in Middlesbrough — Teesside University, Linthorpe & surrounding areas',
    heroSubhead: 'End of Tenancy, Office & Deep Cleans — Instant Quotes in 60 Seconds.',
    rating: 'Rated 4.9/5 by local tenants & landlords',
    proofText: 'DBS-checked professional cleaners | Fully insured & COSHH-compliant | Deposit-Back Guarantee or free re-clean within 48 hours',
    ...
    pricingText: 'We believe in clear, upfront pricing',
    galleryIntro: 'See the difference our expert cleaners deliver:',
    areas: ['Teesside University', 'Linthorpe', 'Town Centre', 'Acklam', 'Marton', 'Nunthorpe'],
    galleryItems: [
