...
// import carpetImage from '@assets/stock_images/professional_house_c_0527fc13.jpg';
const livingRoomImage = '/attached_assets/stock_images/professional_bathroo_bf748bc6.jpg';
const kitchenImage = '/attached_assets/stock_images/professional_kitchen_2ae5ee29.jpg';
...
export default function CommercialCleaningPage() {
  ...
  const handleWhatsAppClick = () => {
    window.open(`https://wa.me/${whatsappNumber.replace(/[^0-9]/g, '')}?text=Hi, I'd like to enquire about commercial cleaning services`, '_blank');
  };

  const handleQuoteClick = () => {
    setLocation('/quote?service=commercial-cleaning');
  };
        ...
        <section className="py-16 bg-background" data-testid="pricing">
          <div className="container mx-auto px-4">
            ...
            <div className="text-center mt-8">
              <Button size="lg" onClick={handleQuoteClick} data-testid="button-quote-business">Get a Free Business Quote</Button>
            </div>
          </div>
        </section>
