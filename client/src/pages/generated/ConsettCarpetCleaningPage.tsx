...
export default function ConsettCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Consett | Steam Cleaning Specialists | County Durham";
  const pageDescription = "Professional carpet & upholstery cleaning in Consett. Steam cleaning & stain removal. Serving Stanley, Durham, Hexham & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"consett"}`)}
        ogType="service"
