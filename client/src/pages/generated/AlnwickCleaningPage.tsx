...
export default function AlnwickCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Alnwick | Regular & One-Off | Northumberland";
  const pageDescription = "Professional cleaning services in Alnwick. Regular domestic cleaning & one-off cleans. Serving Amble, Rothbury, Seahouses & Northumberland. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"alnwick"}`)}
        ogType="service"
