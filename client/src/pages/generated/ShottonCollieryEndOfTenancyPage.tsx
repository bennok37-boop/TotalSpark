...
export default function ShottonCollieryEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Shotton Colliery | Deposit Back Guarantee | County Durham";
  const pageDescription = "Professional end of tenancy cleaning in Shotton Colliery. 100% deposit back guarantee. Serving Horden, Easington, Peterlee & County Durham. Book online today.";
  const cityName = "Shotton Colliery";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"shotton-colliery"}`)}
        ogType="service"
