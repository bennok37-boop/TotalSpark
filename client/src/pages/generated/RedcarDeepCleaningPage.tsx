...
export default function RedcarDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Redcar | Complete Property Restoration | Tees Valley";
  const pageDescription = "Professional deep cleaning in Redcar. Complete property restoration & spring cleaning. Serving Middlesbrough, Saltburn-by-the-Sea, Marske-by-the-Sea & Tees Valley. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"redcar"}`)}
        ogType="service"
