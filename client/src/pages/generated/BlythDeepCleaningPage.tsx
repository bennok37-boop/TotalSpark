...
export default function BlythDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Blyth | Complete Property Restoration | Northumberland";
  const pageDescription = "Professional deep cleaning in Blyth. Complete property restoration & spring cleaning. Serving Ashington, Cramlington, Whitley Bay & Northumberland. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"blyth"}`)}
        ogType="service"
