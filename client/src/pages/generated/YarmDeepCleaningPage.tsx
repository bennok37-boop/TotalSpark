...
export default function YarmDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Yarm | Complete Property Restoration | Tees Valley";
  const pageDescription = "Professional deep cleaning in Yarm. Complete property restoration & spring cleaning. Serving Stockton-on-Tees, Ingleby Barwick, Eaglescliffe & Tees Valley. Transform your space.";
  const cityName = "Yarm";
