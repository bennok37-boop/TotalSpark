...
export default function WashingtonCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Washington | Office & Business Cleaning | Tyne & Wear";
  const pageDescription = "Professional commercial cleaning in Washington. Office cleaning & business services. Serving Sunderland, Houghton-le-Spring, Chester-le-Street & Tyne & Wear businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"washington"}`)}
        ogType="service"
