...
export default function NewcastleuponTyneCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Newcastle upon Tyne | Office & Business Cleaning | Tyne & Wear";
  const pageDescription = "Professional commercial cleaning in Newcastle upon Tyne. Office cleaning & business services. Serving Gateshead & Tyne & Wear businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"newcastle-upon-tyne"}`)}
        ogType="service"
