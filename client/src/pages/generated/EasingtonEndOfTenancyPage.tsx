...
export default function EasingtonEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Easington | Deposit Back Guarantee | County Durham";
  const pageDescription = "Professional end of tenancy cleaning in Easington. 100% deposit back guarantee. Serving Peterlee, Horden, Seaham & County Durham. Book online today.";
  const cityName = "Easington";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"easington"}`)}
        ogType="service"
