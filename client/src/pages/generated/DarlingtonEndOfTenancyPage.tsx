...
export default function DarlingtonEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Darlington | Deposit Back Guarantee | Tees Valley";
  const pageDescription = "Professional end of tenancy cleaning in Darlington. 100% deposit back guarantee. Serving Newton Aycliffe, Barnard Castle & Tees Valley. Book online today.";
  const cityName = "Darlington";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"darlington"}`)}
        ogType="service"
