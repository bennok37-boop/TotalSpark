...
export default function NewtonAycliffeEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Newton Aycliffe | Deposit Back Guarantee | County Durham";
  const pageDescription = "Professional end of tenancy cleaning in Newton Aycliffe. 100% deposit back guarantee. Serving Bishop Auckland, Darlington, Shildon & County Durham. Book online today.";
  const cityName = "Newton Aycliffe";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"newton-aycliffe"}`)}
        ogType="service"
