...
export default function NewtonAycliffeEndOfTenancyPage() {
  // Get tracking numbers for this location
  const trackingNumbers = useTrackingNumbers();
  
  // Set page title and meta description
  useEffect(() => {
    document.title = "End of Tenancy Cleaning Newton Aycliffe | Deposit Back Guarantee | County Durham";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', "Professional end of tenancy cleaning in Newton Aycliffe. 100% deposit back guarantee. Serving Bishop Auckland, Darlington, Shildon & County Durham. Book online today.");
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = "Professional end of tenancy cleaning in Newton Aycliffe. 100% deposit back guarantee. Serving Bishop Auckland, Darlington, Shildon & County Durham. Book online today.";
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <Badge variant="secondary" className="mb-4" data-testid="badge-service-type">
              {"End of Tenancy Cleaning"} in {"Newton Aycliffe"}
            </Badge>
            <h1 className="text-4xl lg:text-6xl font-bold mb-6 text-foreground" data-testid="text-hero-title">
              {"End of Tenancy Cleaning Newton Aycliffe – 100% Deposit Back Guarantee"}
            </h1>
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed" data-testid="text-hero-subtitle">
              {"Professional end of tenancy cleaning across Newton Aycliffe, Bishop Auckland, Darlington, Shildon and surrounding County Durham areas. Get your full deposit back or we'll re-clean free."}
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-6 mt-8 text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-2" data-testid="text-trust-signal">
                ...
                <span>{"Newton Aycliffe Deposit Guarantee - 100% money back"}</span>
              </div>
              ...
              <div className="flex items-center gap-2" data-testid="text-trust-signal">
                <CheckCircle className="h-4 w-4 text-primary" />
                <span>{"24-48hr service available in Newton Aycliffe"}</span>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4" data-testid="text-features-title">
                {"End of Tenancy Cleaning"} Services in {"Newton Aycliffe"}
              </h2>
              <p className="text-lg text-muted-foreground">
                Professional cleaning services across {"Newton Aycliffe"} and surrounding {"County Durham"} areas
              </p>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4" data-testid="text-pricing-title">
                {"End of Tenancy Cleaning"} Prices in {"Newton Aycliffe"}
              </h2>
              <p className="text-lg text-muted-foreground">
                Transparent pricing for {"Newton Aycliffe"} properties
              </p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Card className="hover-elevate" data-testid="card-pricing-0">
                <CardHeader className="text-center">
                  ...
                  <CardDescription>{"Perfect for Newton Aycliffe centre studios"}</CardDescription>
                </CardHeader>
              ...
              <Card className="hover-elevate" data-testid="card-pricing-2">
                <CardHeader className="text-center">
                  ...
                  <CardDescription>{"Common in Newton Aycliffe areas"}</CardDescription>
                </CardHeader>
                <CardContent className="text-center">
              ...
              <Card className="hover-elevate" data-testid="card-pricing-4">
                <CardHeader className="text-center">
                  ...
                  <CardDescription>{"Large Newton Aycliffe properties"}</CardDescription>
                </CardHeader>
                <CardContent className="text-center">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <Card className="hover-elevate cursor-pointer" data-testid="card-area-shildon">
                <CardContent className="p-4">
                  <div className="flex items-center gap-3">
                    <MapPin className="h-4 w-4 text-primary" />
                    <span className="font-medium">{"Shildon"}</span>
                  </div>
                </CardContent>
              </Card>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">
                Common questions about {"end of tenancy cleaning"} in {"Newton Aycliffe"}
              </p>
            </div>
            ...
            <Accordion type="single" collapsible className="space-y-4" data-testid="accordion-faq">
              ...
              <AccordionItem value="item-0" className="border rounded-lg px-6">
                <AccordionTrigger className="text-left font-medium" data-testid="trigger-faq-0">
                  {"Do you guarantee my deposit back in Newton Aycliffe?"}
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pt-2" data-testid="content-faq-0">
                  {"Absolutely — if your Newton Aycliffe landlord or letting agent raises an issue with the cleaning, we'll re-clean within 48 hours completely free of charge. This guarantee covers all Newton Aycliffe areas and County Durham."}
                </AccordionContent>
              </AccordionItem>
              
              <AccordionItem value="item-1" className="border rounded-lg px-6">
                <AccordionTrigger className="text-left font-medium" data-testid="trigger-faq-1">
                  {"Which Newton Aycliffe letting agents do you work with?"}
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pt-2" data-testid="content-faq-1">
                  {"We regularly work with major County Durham letting agents and have extensive experience with Newton Aycliffe property management companies. Our cleaning meets industry standards."}
                </AccordionContent>
              </AccordionItem>
              
              <AccordionItem value="item-2" className="border rounded-lg px-6">
                <AccordionTrigger className="text-left font-medium" data-testid="trigger-faq-2">
                  {"Can you clean student properties in Newton Aycliffe?"}
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pt-2" data-testid="content-faq-2">
                  {"Yes! We specialize in Newton Aycliffe student properties and HMOs. We understand the specific requirements for student house move-outs in the County Durham area."}
                </AccordionContent>
              </AccordionItem>
              
              <AccordionItem value="item-3" className="border rounded-lg px-6">
                <AccordionTrigger className="text-left font-medium" data-testid="trigger-faq-3">
                  {"How quickly can you clean my Newton Aycliffe property?"}
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pt-2" data-testid="content-faq-3">
                  {"We often arrange Newton Aycliffe end of tenancy cleaning within 24-48 hours. Same-day emergency cleaning may be available for urgent Newton Aycliffe move-outs."}
                </AccordionContent>
              </AccordionItem>
              
              <AccordionItem value="item-4" className="border rounded-lg px-6">
                <AccordionTrigger className="text-left font-medium" data-testid="trigger-faq-4">
                  {"Do you bring equipment to Newton Aycliffe properties?"}
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pt-2" data-testid="content-faq-4">
                  {"Yes, all professional cleaning equipment and eco-friendly products are brought to your Newton Aycliffe property. No need to provide anything."}
                </AccordionContent>
              </AccordionItem>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">
                {"End of Tenancy Cleaning"} success stories from {"Newton Aycliffe"} and {"County Durham"}
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <Card className="text-center hover-elevate" data-testid="card-success-0">
                <CardContent className="p-6">
                  ...
                  <h3 className="font-semibold mb-2">{"Newton Aycliffe Student House"}</h3>
              ...
              <Card className="text-center hover-elevate" data-testid="card-success-1">
                <CardContent className="p-6">
                  <Star className="h-8 w-8 text-primary mx-auto mb-4" />
                  <h3 className="font-semibold mb-2">{"Bishop Auckland Flat"}</h3>
              ...
              <Card className="text-center hover-elevate" data-testid="card-success-2">
                <CardContent className="p-6">
                  <Star className="h-8 w-8 text-primary mx-auto mb-4" />
                  <h3 className="font-semibold mb-2">{"Darlington Family Home"}</h3>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4" data-testid="text-final-cta-title">
              Ready to Book {"End of Tenancy Cleaning"} in {"Newton Aycliffe"}?
            </h2>
