...
export default function NewcastleuponTyneCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Newcastle upon Tyne | Steam Cleaning Specialists | Tyne & Wear";
  const pageDescription = "Professional carpet & upholstery cleaning in Newcastle upon Tyne. Steam cleaning & stain removal. Serving Gateshead & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"newcastle-upon-tyne"}`)}
        ogType="service"
