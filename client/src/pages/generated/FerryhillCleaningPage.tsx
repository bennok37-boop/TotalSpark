...
export default function FerryhillCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Ferryhill | Regular & One-Off | County Durham";
  const pageDescription = "Professional cleaning services in Ferryhill. Regular domestic cleaning & one-off cleans. Serving Spennymoor, Sedgefield, Newton Aycliffe & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"ferryhill"}`)}
        ogType="service"
