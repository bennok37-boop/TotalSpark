...
export default function LoftusCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Loftus | Steam Cleaning Specialists | Tees Valley";
  const pageDescription = "Professional carpet & upholstery cleaning in Loftus. Steam cleaning & stain removal. Serving Saltburn-by-the-Sea, Easington & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"loftus"}`)}
        ogType="service"
