...
export default function BillinghamDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Billingham | Complete Property Restoration | Tees Valley";
  const pageDescription = "Professional deep cleaning in Billingham. Complete property restoration & spring cleaning. Serving Stockton-on-Tees, Norton & Tees Valley. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"billingham"}`)}
        ogType="service"
