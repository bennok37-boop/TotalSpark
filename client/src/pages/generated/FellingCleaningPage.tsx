...
export default function FellingCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Felling | Regular & One-Off | Tyne & Wear";
  const pageDescription = "Professional cleaning services in Felling. Regular domestic cleaning & one-off cleans. Serving Gateshead, Jarrow, Hebburn & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"felling"}`)}
        ogType="service"
