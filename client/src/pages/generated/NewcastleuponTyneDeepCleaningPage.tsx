...
export default function NewcastleuponTyneDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Newcastle upon Tyne | Complete Property Restoration | Tyne & Wear";
  const pageDescription = "Professional deep cleaning in Newcastle upon Tyne. Complete property restoration & spring cleaning. Serving Gateshead & Tyne & Wear. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"newcastle-upon-tyne"}`)}
        ogType="service"
