...
export default function PeterleeDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Peterlee | Complete Property Restoration | County Durham";
  const pageDescription = "Professional deep cleaning in Peterlee. Complete property restoration & spring cleaning. Serving Seaham, Hartlepool, Easington & County Durham. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"peterlee"}`)}
        ogType="service"
