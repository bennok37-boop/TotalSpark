...
export default function NewtonAycliffeDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Newton Aycliffe | Complete Property Restoration | County Durham";
  const pageDescription = "Professional deep cleaning in Newton Aycliffe. Complete property restoration & spring cleaning. Serving Bishop Auckland, Darlington, Shildon & County Durham. Transform your space.";
