...
export default function LongbentonDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Longbenton | Complete Property Restoration | Tyne & Wear";
  const pageDescription = "Professional deep cleaning in Longbenton. Complete property restoration & spring cleaning. Serving Wallsend, Killingworth & Tyne & Wear. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"longbenton"}`)}
        ogType="service"
