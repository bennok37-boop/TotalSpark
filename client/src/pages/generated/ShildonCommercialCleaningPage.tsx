...
export default function ShildonCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Shildon | Office & Business Cleaning | County Durham";
  const pageDescription = "Professional commercial cleaning in Shildon. Office cleaning & business services. Serving Newton Aycliffe, Bishop Auckland, Darlington & County Durham businesses. Get quote today.";
