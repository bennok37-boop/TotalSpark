...
export default function InglebyBarwickCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Ingleby Barwick | Office & Business Cleaning | Tees Valley";
  const pageDescription = "Professional commercial cleaning in Ingleby Barwick. Office cleaning & business services. Serving Thornaby, Yarm, Stockton-on-Tees & Tees Valley businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"ingleby-barwick"}`)}
        ogType="service"
