...
export default function SkeltoninClevelandDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Skelton-in-Cleveland | Complete Property Restoration | Tees Valley";
  const pageDescription = "Professional deep cleaning in Skelton-in-Cleveland. Complete property restoration & spring cleaning. Serving Guisborough, Saltburn-by-the-Sea & Tees Valley. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"skelton-in-cleveland"}`)}
        ogType="service"
