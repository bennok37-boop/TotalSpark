...
export default function BirtleyEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Birtley | Deposit Back Guarantee | Tyne & Wear";
  const pageDescription = "Professional end of tenancy cleaning in Birtley. 100% deposit back guarantee. Serving Gateshead, Washington, Chester-le-Street & Tyne & Wear. Book online today.";
  const cityName = "Birtley";
