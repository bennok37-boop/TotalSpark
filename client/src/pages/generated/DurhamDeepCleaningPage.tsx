...
export default function DurhamDeepCleaningPage() {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      ...
      meta.content = "Professional deep cleaning in Durham. Complete property restoration & spring cleaning. Serving Chester-le-Street, Bishop Auckland, Consett & County Durham. Transform your space.";
