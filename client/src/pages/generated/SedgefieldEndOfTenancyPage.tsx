...
export default function SedgefieldEndOfTenancyPage() {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      ...
      meta.content = "Professional end of tenancy cleaning in Sedgefield. 100% deposit back guarantee. Serving Newton Aycliffe, Ferryhill, Stockton-on-Tees & County Durham. Book online today.";
