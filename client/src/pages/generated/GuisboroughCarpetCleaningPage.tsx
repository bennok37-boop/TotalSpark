...
export default function GuisboroughCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Guisborough | Steam Cleaning Specialists | Tees Valley";
  const pageDescription = "Professional carpet & upholstery cleaning in Guisborough. Steam cleaning & stain removal. Serving Saltburn-by-the-Sea, Skelton-in-Cleveland & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"guisborough"}`)}
        ogType="service"
