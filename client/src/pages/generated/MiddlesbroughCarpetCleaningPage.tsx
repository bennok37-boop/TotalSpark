...
export default function MiddlesbroughCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Middlesbrough | Steam Cleaning Specialists | Tees Valley";
  const pageDescription = "Professional carpet & upholstery cleaning in Middlesbrough. Steam cleaning & stain removal. Serving Stockton-on-Tees, Redcar, Thornaby & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"middlesbrough"}`)}
        ogType="service"
