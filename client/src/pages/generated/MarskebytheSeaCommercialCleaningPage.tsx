...
export default function MarskebytheSeaCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Marske-by-the-Sea | Office & Business Cleaning | Tees Valley";
  const pageDescription = "Professional commercial cleaning in Marske-by-the-Sea. Office cleaning & business services. Serving Redcar, Saltburn-by-the-Sea & Tees Valley businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"marske-by-the-sea"}`)}
        ogType="service"
