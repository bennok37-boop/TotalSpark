...
export default function HebburnCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Hebburn | Steam Cleaning Specialists | Tyne & Wear";
  const pageDescription = "Professional carpet & upholstery cleaning in Hebburn. Steam cleaning & stain removal. Serving Jarrow, South Shields, Gateshead & Tyne & Wear. Book today.";
  const cityName = "Hebburn";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"hebburn"}`)}
        ogType="service"
