...
export default function SouthShieldsCommercialCleaningPage() {
  ...
  useEffect(() => {
    document.title = "Commercial Cleaning Services South Shields | Office & Business Cleaning | Tyne & Wear";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', "Professional commercial cleaning in South Shields. Office cleaning & business services. Serving North Shields, Jarrow, Hebburn & Tyne & Wear businesses. Get quote today.");
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = "Professional commercial cleaning in South Shields. Office cleaning & business services. Serving North Shields, Jarrow, Hebburn & Tyne & Wear businesses. Get quote today.";
