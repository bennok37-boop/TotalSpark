...
export default function BoldonCleaningPage() {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      ...
      meta.content = "Professional cleaning services in Boldon. Regular domestic cleaning & one-off cleans. Serving South Shields, Sunderland, Washington & Tyne & Wear. Book today.";
