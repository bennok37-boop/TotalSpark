...
export default function NortonCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Norton | Steam Cleaning Specialists | Tees Valley";
  const pageDescription = "Professional carpet & upholstery cleaning in Norton. Steam cleaning & stain removal. Serving Stockton-on-Tees, Billingham & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"norton"}`)}
        ogType="service"
