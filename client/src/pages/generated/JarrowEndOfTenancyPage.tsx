...
export default function JarrowEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Jarrow | Deposit Back Guarantee | Tyne & Wear";
  const pageDescription = "Professional end of tenancy cleaning in Jarrow. 100% deposit back guarantee. Serving South Shields, Hebburn, Gateshead & Tyne & Wear. Book online today.";
  const cityName = "Jarrow";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"jarrow"}`)}
        ogType="service"
