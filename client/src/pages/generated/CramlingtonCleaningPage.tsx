...
export default function CramlingtonCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Cramlington | Regular & One-Off | Northumberland";
  const pageDescription = "Professional cleaning services in Cramlington. Regular domestic cleaning & one-off cleans. Serving Blyth, Morpeth, Ponteland & Northumberland. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"cramlington"}`)}
        ogType="service"
