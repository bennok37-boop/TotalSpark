...
export default function FerryhillDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Ferryhill | Complete Property Restoration | County Durham";
  const pageDescription = "Professional deep cleaning in Ferryhill. Complete property restoration & spring cleaning. Serving Spennymoor, Sedgefield, Newton Aycliffe & County Durham. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"ferryhill"}`)}
        ogType="service"
