...
export default function StocktononTeesDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Stockton-on-Tees | Complete Property Restoration | Tees Valley";
  const pageDescription = "Professional deep cleaning in Stockton-on-Tees. Complete property restoration & spring cleaning. Serving Middlesbrough, Thornaby, Billingham & Tees Valley. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"stockton-on-tees"}`)}
        ogType="service"
