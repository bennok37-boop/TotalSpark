...
export default function DarlingtonCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Darlington | Office & Business Cleaning | Tees Valley";
  const pageDescription = "Professional commercial cleaning in Darlington. Office cleaning & business services. Serving Newton Aycliffe, Barnard Castle & Tees Valley businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"darlington"}`)}
        ogType="service"
