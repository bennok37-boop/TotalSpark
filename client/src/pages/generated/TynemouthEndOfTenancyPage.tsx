...
export default function TynemouthEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Tynemouth | Deposit Back Guarantee | Tyne & Wear";
  const pageDescription = "Professional end of tenancy cleaning in Tynemouth. 100% deposit back guarantee. Serving North Shields, Whitley Bay, South Shields & Tyne & Wear. Book online today.";
  const cityName = "Tynemouth";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"tynemouth"}`)}
        ogType="service"
