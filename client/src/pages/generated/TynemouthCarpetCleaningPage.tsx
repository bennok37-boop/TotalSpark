...
export default function TynemouthCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Tynemouth | Steam Cleaning Specialists | Tyne & Wear";
  const pageDescription = "Professional carpet & upholstery cleaning in Tynemouth. Steam cleaning & stain removal. Serving North Shields, Whitley Bay, South Shields & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"tynemouth"}`)}
        ogType="service"
