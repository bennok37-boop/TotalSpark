...
export default function RedcarCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Redcar | Steam Cleaning Specialists | Tees Valley";
  const pageDescription = "Professional carpet & upholstery cleaning in Redcar. Steam cleaning & stain removal. Serving Middlesbrough, Saltburn-by-the-Sea, Marske-by-the-Sea & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"redcar"}`)}
        ogType="service"
