...
export default function SedgefieldCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Sedgefield | Office & Business Cleaning | County Durham";
  const pageDescription = "Professional commercial cleaning in Sedgefield. Office cleaning & business services. Serving Newton Aycliffe, Ferryhill, Stockton-on-Tees & County Durham businesses. Get quote today.";
  const cityName = "Sedgefield";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"sedgefield"}`)}
        ogType="service"
