...
export default function LongbentonCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Longbenton | Office & Business Cleaning | Tyne & Wear";
  const pageDescription = "Professional commercial cleaning in Longbenton. Office cleaning & business services. Serving Wallsend, Killingworth & Tyne & Wear businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"longbenton"}`)}
        ogType="service"
