...
export default function NewbigginbytheSeaCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Newbiggin-by-the-Sea | Steam Cleaning Specialists | Northumberland";
  const pageDescription = "Professional carpet & upholstery cleaning in Newbiggin-by-the-Sea. Steam cleaning & stain removal. Serving Ashington, Blyth & Northumberland. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"newbiggin-by-the-sea"}`)}
        ogType="service"
