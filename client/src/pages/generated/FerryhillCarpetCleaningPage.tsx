...
export default function FerryhillCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Ferryhill | Steam Cleaning Specialists | County Durham";
  const pageDescription = "Professional carpet & upholstery cleaning in Ferryhill. Steam cleaning & stain removal. Serving Spennymoor, Sedgefield, Newton Aycliffe & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"ferryhill"}`)}
        ogType="service"
