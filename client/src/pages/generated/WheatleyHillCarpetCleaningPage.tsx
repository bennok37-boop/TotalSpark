...
export default function WheatleyHillCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Wheatley Hill | Steam Cleaning Specialists | County Durham";
  const pageDescription = "Professional carpet & upholstery cleaning in Wheatley Hill. Steam cleaning & stain removal. Serving Shotton Colliery, Trimdon & County Durham. Book today.";
