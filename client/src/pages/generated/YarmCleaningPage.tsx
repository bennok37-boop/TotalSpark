...
export default function YarmCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Yarm | Regular & One-Off | Tees Valley";
  const pageDescription = "Professional cleaning services in Yarm. Regular domestic cleaning & one-off cleans. Serving Stockton-on-Tees, Ingleby Barwick, Eaglescliffe & Tees Valley. Book today.";
  const cityName = "Yarm";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"yarm"}`)}
        ogType="service"
