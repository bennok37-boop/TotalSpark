...
export default function WashingtonCarpetCleaningPage() {
  ...
  useEffect(() => {
    document.title = "Carpet & Upholstery Cleaning Washington | Steam Cleaning Specialists | Tyne & Wear";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', "Professional carpet & upholstery cleaning in Washington. Steam cleaning & stain removal. Serving Sunderland, Houghton-le-Spring, Chester-le-Street & Tyne & Wear. Book today.");
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = "Professional carpet & upholstery cleaning in Washington. Steam cleaning & stain removal. Serving Sunderland, Houghton-le-Spring, Chester-le-Street & Tyne & Wear. Book today.";
