...
export default function CramlingtonCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Cramlington | Steam Cleaning Specialists | Northumberland";
  const pageDescription = "Professional carpet & upholstery cleaning in Cramlington. Steam cleaning & stain removal. Serving Blyth, Morpeth, Ponteland & Northumberland. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"cramlington"}`)}
        ogType="service"
