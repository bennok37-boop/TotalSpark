...
export default function NewbigginbytheSeaCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Newbiggin-by-the-Sea | Regular & One-Off | Northumberland";
  const pageDescription = "Professional cleaning services in Newbiggin-by-the-Sea. Regular domestic cleaning & one-off cleans. Serving Ashington, Blyth & Northumberland. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"newbiggin-by-the-sea"}`)}
        ogType="service"
