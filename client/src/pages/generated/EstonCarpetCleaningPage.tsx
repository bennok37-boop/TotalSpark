...
export default function EstonCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Eston | Steam Cleaning Specialists | Tees Valley";
  const pageDescription = "Professional carpet & upholstery cleaning in Eston. Steam cleaning & stain removal. Serving Middlesbrough, Redcar, Grangetown & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"eston"}`)}
        ogType="service"
