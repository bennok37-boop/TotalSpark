...
export default function AshingtonCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Ashington | Steam Cleaning Specialists | Northumberland";
  const pageDescription = "Professional carpet & upholstery cleaning in Ashington. Steam cleaning & stain removal. Serving Blyth, Morpeth, Newbiggin-by-the-Sea & Northumberland. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"ashington"}`)}
        ogType="service"
