...
export default function CorbridgeDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Corbridge | Complete Property Restoration | Northumberland";
  const pageDescription = "Professional deep cleaning in Corbridge. Complete property restoration & spring cleaning. Serving Hexham, Prudhoe & Northumberland. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"corbridge"}`)}
        ogType="service"
