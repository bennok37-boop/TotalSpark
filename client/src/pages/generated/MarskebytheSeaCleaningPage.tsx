...
export default function MarskebytheSeaCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Marske-by-the-Sea | Regular & One-Off | Tees Valley";
  const pageDescription = "Professional cleaning services in Marske-by-the-Sea. Regular domestic cleaning & one-off cleans. Serving Redcar, Saltburn-by-the-Sea & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"marske-by-the-sea"}`)}
        ogType="service"
