...
export default function SpennymoorCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Spennymoor | Steam Cleaning Specialists | County Durham";
  const pageDescription = "Professional carpet & upholstery cleaning in Spennymoor. Steam cleaning & stain removal. Serving Bishop Auckland, Durham, Ferryhill & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"spennymoor"}`)}
        ogType="service"
