...
export default function MarskebytheSeaCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Marske-by-the-Sea | Steam Cleaning Specialists | Tees Valley";
  const pageDescription = "Professional carpet & upholstery cleaning in Marske-by-the-Sea. Steam cleaning & stain removal. Serving Redcar, Saltburn-by-the-Sea & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"marske-by-the-sea"}`)}
        ogType="service"
