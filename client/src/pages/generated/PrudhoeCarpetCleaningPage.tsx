...
export default function PrudhoeCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Prudhoe | Steam Cleaning Specialists | Northumberland";
  const pageDescription = "Professional carpet & upholstery cleaning in Prudhoe. Steam cleaning & stain removal. Serving Hexham, Corbridge, Blaydon-on-Tyne & Northumberland. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"prudhoe"}`)}
        ogType="service"
