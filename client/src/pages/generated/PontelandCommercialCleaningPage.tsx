...
export default function PontelandCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Ponteland | Office & Business Cleaning | Northumberland";
  const pageDescription = "Professional commercial cleaning in Ponteland. Office cleaning & business services. Serving Cramlington, Morpeth, Newcastle upon Tyne & Northumberland businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"ponteland"}`)}
        ogType="service"
