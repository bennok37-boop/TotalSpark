...
export default function DurhamCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Durham | Regular & One-Off | County Durham";
  const pageDescription = "Professional cleaning services in Durham. Regular domestic cleaning & one-off cleans. Serving Chester-le-Street, Bishop Auckland, Consett & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"durham"}`)}
        ogType="service"
