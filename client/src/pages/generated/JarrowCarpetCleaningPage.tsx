...
export default function JarrowCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Jarrow | Steam Cleaning Specialists | Tyne & Wear";
  const pageDescription = "Professional carpet & upholstery cleaning in Jarrow. Steam cleaning & stain removal. Serving South Shields, Hebburn, Gateshead & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"jarrow"}`)}
        ogType="service"
