...
export default function BedlingtonDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Bedlington | Complete Property Restoration | Northumberland";
  const pageDescription = "Professional deep cleaning in Bedlington. Complete property restoration & spring cleaning. Serving Ashington, Cramlington, Blyth & Northumberland. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"bedlington"}`)}
        ogType="service"
