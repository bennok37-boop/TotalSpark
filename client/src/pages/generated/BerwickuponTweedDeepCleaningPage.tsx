...
export default function BerwickuponTweedDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Berwick-upon-Tweed | Complete Property Restoration | Northumberland";
  const pageDescription = "Professional deep cleaning in Berwick-upon-Tweed. Complete property restoration & spring cleaning. Serving Wooler & Northumberland. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"berwick-upon-tweed"}`)}
        ogType="service"
