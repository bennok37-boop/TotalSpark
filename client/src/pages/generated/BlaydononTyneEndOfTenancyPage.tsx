...
export default function BlaydononTyneEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Blaydon-on-Tyne | Deposit Back Guarantee | Tyne & Wear";
  const pageDescription = "Professional end of tenancy cleaning in Blaydon-on-Tyne. 100% deposit back guarantee. Serving Gateshead, Prudhoe & Tyne & Wear. Book online today.";
  const cityName = "Blaydon-on-Tyne";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"blaydon-on-tyne"}`)}
        ogType="service"
