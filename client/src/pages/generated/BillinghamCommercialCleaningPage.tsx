...
export default function BillinghamCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Billingham | Office & Business Cleaning | Tees Valley";
  const pageDescription = "Professional commercial cleaning in Billingham. Office cleaning & business services. Serving Stockton-on-Tees, Norton & Tees Valley businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"billingham"}`)}
        ogType="service"
