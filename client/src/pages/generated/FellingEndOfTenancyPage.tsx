...
export default function FellingEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Felling | Deposit Back Guarantee | Tyne & Wear";
  const pageDescription = "Professional end of tenancy cleaning in Felling. 100% deposit back guarantee. Serving Gateshead, Jarrow, Hebburn & Tyne & Wear. Book online today.";
  const cityName = "Felling";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"felling"}`)}
        ogType="service"
