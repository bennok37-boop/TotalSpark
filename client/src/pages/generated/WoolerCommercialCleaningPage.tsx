...
export default function WoolerCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Wooler | Office & Business Cleaning | Northumberland";
  const pageDescription = "Professional commercial cleaning in Wooler. Office cleaning & business services. Serving Berwick-upon-Tweed, Alnwick & Northumberland businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"wooler"}`)}
        ogType="service"
