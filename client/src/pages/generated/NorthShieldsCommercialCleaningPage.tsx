...
export default function NorthShieldsCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services North Shields | Office & Business Cleaning | Tyne & Wear";
  const pageDescription = "Professional commercial cleaning in North Shields. Office cleaning & business services. Serving Tynemouth, Whitley Bay, Wallsend & Tyne & Wear businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"north-shields"}`)}
        ogType="service"
