...
export default function BedlingtonCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Bedlington | Regular & One-Off | Northumberland";
  const pageDescription = "Professional cleaning services in Bedlington. Regular domestic cleaning & one-off cleans. Serving Ashington, Cramlington, Blyth & Northumberland. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"bedlington"}`)}
        ogType="service"
