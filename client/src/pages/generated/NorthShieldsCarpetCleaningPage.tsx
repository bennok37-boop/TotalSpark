...
export default function NorthShieldsCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning North Shields | Steam Cleaning Specialists | Tyne & Wear";
  const pageDescription = "Professional carpet & upholstery cleaning in North Shields. Steam cleaning & stain removal. Serving Tynemouth, Whitley Bay, Wallsend & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"north-shields"}`)}
        ogType="service"
