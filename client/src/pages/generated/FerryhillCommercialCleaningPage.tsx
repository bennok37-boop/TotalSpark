...
export default function FerryhillCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Ferryhill | Office & Business Cleaning | County Durham";
  const pageDescription = "Professional commercial cleaning in Ferryhill. Office cleaning & business services. Serving Spennymoor, Sedgefield, Newton Aycliffe & County Durham businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"ferryhill"}`)}
        ogType="service"
