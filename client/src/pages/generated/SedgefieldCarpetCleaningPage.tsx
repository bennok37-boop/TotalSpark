...
export default function SedgefieldCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Sedgefield | Steam Cleaning Specialists | County Durham";
  const pageDescription = "Professional carpet & upholstery cleaning in Sedgefield. Steam cleaning & stain removal. Serving Newton Aycliffe, Ferryhill, Stockton-on-Tees & County Durham. Book today.";
