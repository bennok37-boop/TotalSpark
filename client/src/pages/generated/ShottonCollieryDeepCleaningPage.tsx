...
export default function ShottonCollieryDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Shotton Colliery | Complete Property Restoration | County Durham";
  const pageDescription = "Professional deep cleaning in Shotton Colliery. Complete property restoration & spring cleaning. Serving Horden, Easington, Peterlee & County Durham. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"shotton-colliery"}`)}
        ogType="service"
