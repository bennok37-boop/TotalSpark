...
export default function SkeltoninClevelandCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Skelton-in-Cleveland | Regular & One-Off | Tees Valley";
  const pageDescription = "Professional cleaning services in Skelton-in-Cleveland. Regular domestic cleaning & one-off cleans. Serving Guisborough, Saltburn-by-the-Sea & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"skelton-in-cleveland"}`)}
        ogType="service"
