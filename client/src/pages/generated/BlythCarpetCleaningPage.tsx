...
export default function BlythCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Blyth | Steam Cleaning Specialists | Northumberland";
  const pageDescription = "Professional carpet & upholstery cleaning in Blyth. Steam cleaning & stain removal. Serving Ashington, Cramlington, Whitley Bay & Northumberland. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"blyth"}`)}
        ogType="service"
