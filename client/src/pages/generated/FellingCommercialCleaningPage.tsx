...
export default function FellingCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Felling | Office & Business Cleaning | Tyne & Wear";
  const pageDescription = "Professional commercial cleaning in Felling. Office cleaning & business services. Serving Gateshead, Jarrow, Hebburn & Tyne & Wear businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"felling"}`)}
        ogType="service"
