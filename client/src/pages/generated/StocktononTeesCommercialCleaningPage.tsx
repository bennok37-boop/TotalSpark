...
export default function StocktononTeesCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Stockton-on-Tees | Office & Business Cleaning | Tees Valley";
  const pageDescription = "Professional commercial cleaning in Stockton-on-Tees. Office cleaning & business services. Serving Middlesbrough, Thornaby, Billingham & Tees Valley businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"stockton-on-tees"}`)}
        ogType="service"
