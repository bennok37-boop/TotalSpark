...
export default function MorpethCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Morpeth | Regular & One-Off | Northumberland";
  const pageDescription = "Professional cleaning services in Morpeth. Regular domestic cleaning & one-off cleans. Serving Ashington, Blyth, Cramlington & Northumberland. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"morpeth"}`)}
        ogType="service"
