...
export default function JarrowCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Jarrow | Office & Business Cleaning | Tyne & Wear";
  const pageDescription = "Professional commercial cleaning in Jarrow. Office cleaning & business services. Serving South Shields, Hebburn, Gateshead & Tyne & Wear businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"jarrow"}`)}
        ogType="service"
