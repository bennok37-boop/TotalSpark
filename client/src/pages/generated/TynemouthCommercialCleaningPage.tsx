...
export default function TynemouthCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Tynemouth | Office & Business Cleaning | Tyne & Wear";
  const pageDescription = "Professional commercial cleaning in Tynemouth. Office cleaning & business services. Serving North Shields, Whitley Bay, South Shields & Tyne & Wear businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"tynemouth"}`)}
        ogType="service"
