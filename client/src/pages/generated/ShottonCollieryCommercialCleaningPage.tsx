...
export default function ShottonCollieryCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Shotton Colliery | Office & Business Cleaning | County Durham";
  const pageDescription = "Professional commercial cleaning in Shotton Colliery. Office cleaning & business services. Serving Horden, Easington, Peterlee & County Durham businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"shotton-colliery"}`)}
        ogType="service"
