...
export default function MorpethEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Morpeth | Deposit Back Guarantee | Northumberland";
  const pageDescription = "Professional end of tenancy cleaning in Morpeth. 100% deposit back guarantee. Serving Ashington, Blyth, Cramlington & Northumberland. Book online today.";
  const cityName = "Morpeth";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"morpeth"}`)}
        ogType="service"
