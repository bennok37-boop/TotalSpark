...
export default function SeahousesDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Seahouses | Complete Property Restoration | Northumberland";
  const pageDescription = "Professional deep cleaning in Seahouses. Complete property restoration & spring cleaning. Serving Alnwick, Amble & Northumberland. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"seahouses"}`)}
        ogType="service"
