...
export default function BillinghamCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Billingham | Regular & One-Off | Tees Valley";
  const pageDescription = "Professional cleaning services in Billingham. Regular domestic cleaning & one-off cleans. Serving Stockton-on-Tees, Norton & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"billingham"}`)}
        ogType="service"
