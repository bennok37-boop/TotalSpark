...
export default function WheatleyHillCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Wheatley Hill | Office & Business Cleaning | County Durham";
  const pageDescription = "Professional commercial cleaning in Wheatley Hill. Office cleaning & business services. Serving Shotton Colliery, Trimdon & County Durham businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"wheatley-hill"}`)}
        ogType="service"
