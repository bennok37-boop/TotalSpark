...
export default function ShildonEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Shildon | Deposit Back Guarantee | County Durham";
  const pageDescription = "Professional end of tenancy cleaning in Shildon. 100% deposit back guarantee. Serving Newton Aycliffe, Bishop Auckland, Darlington & County Durham. Book online today.";
  const cityName = "Shildon";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"shildon"}`)}
        ogType="service"
