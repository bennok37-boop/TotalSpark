...
export default function HexhamCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Hexham | Regular & One-Off | Northumberland";
  const pageDescription = "Professional cleaning services in Hexham. Regular domestic cleaning & one-off cleans. Serving Corbridge, Prudhoe, Haltwhistle & Northumberland. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"hexham"}`)}
        ogType="service"
