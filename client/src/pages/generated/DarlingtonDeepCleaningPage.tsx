...
export default function DarlingtonDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Darlington | Complete Property Restoration | Tees Valley";
  const pageDescription = "Professional deep cleaning in Darlington. Complete property restoration & spring cleaning. Serving Newton Aycliffe, Barnard Castle & Tees Valley. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"darlington"}`)}
        ogType="service"
