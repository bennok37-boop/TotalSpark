...
export default function ChesterleStreetDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Chester-le-Street | Complete Property Restoration | County Durham";
  const pageDescription = "Professional deep cleaning in Chester-le-Street. Complete property restoration & spring cleaning. Serving Durham, Washington, Stanley & County Durham. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"chester-le-street"}`)}
        ogType="service"
