...
export default function BirtleyCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Birtley | Regular & One-Off | Tyne & Wear";
  const pageDescription = "Professional cleaning services in Birtley. Regular domestic cleaning & one-off cleans. Serving Gateshead, Washington, Chester-le-Street & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"birtley"}`)}
        ogType="service"
