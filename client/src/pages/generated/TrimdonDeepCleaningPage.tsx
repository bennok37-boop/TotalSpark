...
export default function TrimdonDeepCleaningPage() {
  ...
  useEffect(() => {
    document.title = "Deep Cleaning Services Trimdon | Complete Property Restoration | County Durham";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', "Professional deep cleaning in Trimdon. Complete property restoration & spring cleaning. Serving Sedgefield, Ferryhill & County Durham. Transform your space.");
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = "Professional deep cleaning in Trimdon. Complete property restoration & spring cleaning. Serving Sedgefield, Ferryhill & County Durham. Transform your space.";
