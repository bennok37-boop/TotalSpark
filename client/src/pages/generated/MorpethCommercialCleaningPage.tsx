...
export default function MorpethCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Morpeth | Office & Business Cleaning | Northumberland";
  const pageDescription = "Professional commercial cleaning in Morpeth. Office cleaning & business services. Serving Ashington, Blyth, Cramlington & Northumberland businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"morpeth"}`)}
        ogType="service"
