...
export default function ThornabyCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Thornaby | Steam Cleaning Specialists | Tees Valley";
  const pageDescription = "Professional carpet & upholstery cleaning in Thornaby. Steam cleaning & stain removal. Serving Stockton-on-Tees, Middlesbrough, Yarm & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"thornaby"}`)}
        ogType="service"
