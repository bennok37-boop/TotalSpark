...
export default function SaltburnbytheSeaCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Saltburn-by-the-Sea | Steam Cleaning Specialists | Tees Valley";
  const pageDescription = "Professional carpet & upholstery cleaning in Saltburn-by-the-Sea. Steam cleaning & stain removal. Serving Redcar, Marske-by-the-Sea, Guisborough & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"saltburn-by-the-sea"}`)}
        ogType="service"
