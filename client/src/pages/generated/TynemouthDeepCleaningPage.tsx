...
export default function TynemouthDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Tynemouth | Complete Property Restoration | Tyne & Wear";
  const pageDescription = "Professional deep cleaning in Tynemouth. Complete property restoration & spring cleaning. Serving North Shields, Whitley Bay, South Shields & Tyne & Wear. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"tynemouth"}`)}
        ogType="service"
