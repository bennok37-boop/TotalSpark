...
export default function RedcarCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Redcar | Regular & One-Off | Tees Valley";
  const pageDescription = "Professional cleaning services in Redcar. Regular domestic cleaning & one-off cleans. Serving Middlesbrough, Saltburn-by-the-Sea, Marske-by-the-Sea & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"redcar"}`)}
        ogType="service"
