...
export default function AmbleCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Amble | Office & Business Cleaning | Northumberland";
  const pageDescription = "Professional commercial cleaning in Amble. Office cleaning & business services. Serving Alnwick, Seahouses & Northumberland businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"amble"}`)}
        ogType="service"
