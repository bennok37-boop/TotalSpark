...
export default function ChesterleStreetCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Chester-le-Street | Regular & One-Off | County Durham";
  const pageDescription = "Professional cleaning services in Chester-le-Street. Regular domestic cleaning & one-off cleans. Serving Durham, Washington, Stanley & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"chester-le-street"}`)}
        ogType="service"
