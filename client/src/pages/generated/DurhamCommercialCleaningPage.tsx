...
export default function DurhamCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Durham | Office & Business Cleaning | County Durham";
  const pageDescription = "Professional commercial cleaning in Durham. Office cleaning & business services. Serving Chester-le-Street, Bishop Auckland, Consett & County Durham businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"durham"}`)}
        ogType="service"
