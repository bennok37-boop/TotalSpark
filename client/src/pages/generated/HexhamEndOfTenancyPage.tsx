...
export default function HexhamEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Hexham | Deposit Back Guarantee | Northumberland";
  const pageDescription = "Professional end of tenancy cleaning in Hexham. 100% deposit back guarantee. Serving Corbridge, Prudhoe, Haltwhistle & Northumberland. Book online today.";
  const cityName = "Hexham";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"hexham"}`)}
        ogType="service"
