...
export default function HebburnCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Hebburn | Regular & One-Off | Tyne & Wear";
  const pageDescription = "Professional cleaning services in Hebburn. Regular domestic cleaning & one-off cleans. Serving Jarrow, South Shields, Gateshead & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"hebburn"}`)}
        ogType="service"
