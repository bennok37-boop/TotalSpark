...
export default function WhitleyBayCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Whitley Bay | Steam Cleaning Specialists | Tyne & Wear";
  const pageDescription = "Professional carpet & upholstery cleaning in Whitley Bay. Steam cleaning & stain removal. Serving Tynemouth, North Shields, Blyth & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"whitley-bay"}`)}
        ogType="service"
