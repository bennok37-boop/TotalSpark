...
export default function SedgefieldDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Sedgefield | Complete Property Restoration | County Durham";
  const pageDescription = "Professional deep cleaning in Sedgefield. Complete property restoration & spring cleaning. Serving Newton Aycliffe, Ferryhill, Stockton-on-Tees & County Durham. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"sedgefield"}`)}
        ogType="service"
