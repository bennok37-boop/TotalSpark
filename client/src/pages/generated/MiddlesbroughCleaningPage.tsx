...
export default function MiddlesbroughCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Middlesbrough | Regular & One-Off | Tees Valley";
  const pageDescription = "Professional cleaning services in Middlesbrough. Regular domestic cleaning & one-off cleans. Serving Stockton-on-Tees, Redcar, Thornaby & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"middlesbrough"}`)}
        ogType="service"
