...
export default function HartlepoolCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Hartlepool | Office & Business Cleaning | Tees Valley";
  const pageDescription = "Professional commercial cleaning in Hartlepool. Office cleaning & business services. Serving Peterlee, Billingham & Tees Valley businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"hartlepool"}`)}
        ogType="service"
