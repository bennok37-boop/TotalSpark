...
export default function BlaydononTyneCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Blaydon-on-Tyne | Office & Business Cleaning | Tyne & Wear";
  const pageDescription = "Professional commercial cleaning in Blaydon-on-Tyne. Office cleaning & business services. Serving Gateshead, Prudhoe & Tyne & Wear businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"blaydon-on-tyne"}`)}
        ogType="service"
