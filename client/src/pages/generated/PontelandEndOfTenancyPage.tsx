...
export default function PontelandEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Ponteland | Deposit Back Guarantee | Northumberland";
  const pageDescription = "Professional end of tenancy cleaning in Ponteland. 100% deposit back guarantee. Serving Cramlington, Morpeth, Newcastle upon Tyne & Northumberland. Book online today.";
  const cityName = "Ponteland";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"ponteland"}`)}
        ogType="service"
