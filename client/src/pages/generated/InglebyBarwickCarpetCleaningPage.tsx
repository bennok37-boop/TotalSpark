...
export default function InglebyBarwickCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Ingleby Barwick | Steam Cleaning Specialists | Tees Valley";
  const pageDescription = "Professional carpet & upholstery cleaning in Ingleby Barwick. Steam cleaning & stain removal. Serving Thornaby, Yarm, Stockton-on-Tees & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"ingleby-barwick"}`)}
        ogType="service"
