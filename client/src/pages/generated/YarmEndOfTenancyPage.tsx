...
export default function YarmEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Yarm | Deposit Back Guarantee | Tees Valley";
  const pageDescription = "Professional end of tenancy cleaning in Yarm. 100% deposit back guarantee. Serving Stockton-on-Tees, Ingleby Barwick, Eaglescliffe & Tees Valley. Book online today.";
  const cityName = "Yarm";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"yarm"}`)}
        ogType="service"
