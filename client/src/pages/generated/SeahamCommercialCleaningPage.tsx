...
export default function SeahamCommercialCleaningPage() {
  ...
  useEffect(() => {
    document.title = "Commercial Cleaning Services Seaham | Office & Business Cleaning | County Durham";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', "Professional commercial cleaning in Seaham. Office cleaning & business services. Serving Sunderland, Houghton-le-Spring, Peterlee & County Durham businesses. Get quote today.");
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = "Professional commercial cleaning in Seaham. Office cleaning & business services. Serving Sunderland, Houghton-le-Spring, Peterlee & County Durham businesses. Get quote today.";
