...
export default function HebburnCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Hebburn | Office & Business Cleaning | Tyne & Wear";
  const pageDescription = "Professional commercial cleaning in Hebburn. Office cleaning & business services. Serving Jarrow, South Shields, Gateshead & Tyne & Wear businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"hebburn"}`)}
        ogType="service"
