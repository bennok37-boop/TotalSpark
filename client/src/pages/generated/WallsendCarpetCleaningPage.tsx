...
export default function WallsendCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Wallsend | Steam Cleaning Specialists | Tyne & Wear";
  const pageDescription = "Professional carpet & upholstery cleaning in Wallsend. Steam cleaning & stain removal. Serving North Shields, Tynemouth, Longbenton & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"wallsend"}`)}
        ogType="service"
