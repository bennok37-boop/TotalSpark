...
export default function NewbigginbytheSeaCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Newbiggin-by-the-Sea | Office & Business Cleaning | Northumberland";
  const pageDescription = "Professional commercial cleaning in Newbiggin-by-the-Sea. Office cleaning & business services. Serving Ashington, Blyth & Northumberland businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"newbiggin-by-the-sea"}`)}
        ogType="service"
