...
export default function HaltwhistleEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Haltwhistle | Deposit Back Guarantee | Northumberland";
  const pageDescription = "Professional end of tenancy cleaning in Haltwhistle. 100% deposit back guarantee. Serving Hexham & Northumberland. Book online today.";
  const cityName = "Haltwhistle";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"haltwhistle"}`)}
        ogType="service"
