...
export default function BlaydononTyneCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Blaydon-on-Tyne | Regular & One-Off | Tyne & Wear";
  const pageDescription = "Professional cleaning services in Blaydon-on-Tyne. Regular domestic cleaning & one-off cleans. Serving Gateshead, Prudhoe & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"blaydon-on-tyne"}`)}
        ogType="service"
