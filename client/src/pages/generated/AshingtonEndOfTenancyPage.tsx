...
export default function AshingtonEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Ashington | Deposit Back Guarantee | Northumberland";
  const pageDescription = "Professional end of tenancy cleaning in Ashington. 100% deposit back guarantee. Serving Blyth, Morpeth, Newbiggin-by-the-Sea & Northumberland. Book online today.";
  const cityName = "Ashington";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"ashington"}`)}
        ogType="service"
