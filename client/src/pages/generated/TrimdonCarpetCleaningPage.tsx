...
export default function TrimdonCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Trimdon | Steam Cleaning Specialists | County Durham";
  const pageDescription = "Professional carpet & upholstery cleaning in Trimdon. Steam cleaning & stain removal. Serving Sedgefield, Ferryhill & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"trimdon"}`)}
        ogType="service"
