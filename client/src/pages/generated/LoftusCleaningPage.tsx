...
export default function LoftusCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Loftus | Regular & One-Off | Tees Valley";
  const pageDescription = "Professional cleaning services in Loftus. Regular domestic cleaning & one-off cleans. Serving Saltburn-by-the-Sea, Easington & Tees Valley. Book today.";
