...
export default function LongbentonCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Longbenton | Steam Cleaning Specialists | Tyne & Wear";
  const pageDescription = "Professional carpet & upholstery cleaning in Longbenton. Steam cleaning & stain removal. Serving Wallsend, Killingworth & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"longbenton"}`)}
        ogType="service"
