...
export default function DurhamEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Durham | Deposit Back Guarantee | County Durham";
  const pageDescription = "Professional end of tenancy cleaning in Durham. 100% deposit back guarantee. Serving Chester-le-Street, Bishop Auckland, Consett & County Durham. Book online today.";
  const cityName = "Durham";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"durham"}`)}
        ogType="service"
