...
export default function GrangetownCommercialCleaningPage() {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      ...
      meta.content = "Professional commercial cleaning in Grangetown. Office cleaning & business services. Serving Middlesbrough, Redcar, Eston & Tees Valley businesses. Get quote today.";
