...
export default function PrudhoeCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Prudhoe | Regular & One-Off | Northumberland";
  const pageDescription = "Professional cleaning services in Prudhoe. Regular domestic cleaning & one-off cleans. Serving Hexham, Corbridge, Blaydon-on-Tyne & Northumberland. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"prudhoe"}`)}
        ogType="service"
