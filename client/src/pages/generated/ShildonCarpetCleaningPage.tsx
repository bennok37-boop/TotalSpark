...
export default function ShildonCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Shildon | Steam Cleaning Specialists | County Durham";
  const pageDescription = "Professional carpet & upholstery cleaning in Shildon. Steam cleaning & stain removal. Serving Newton Aycliffe, Bishop Auckland, Darlington & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"shildon"}`)}
        ogType="service"
