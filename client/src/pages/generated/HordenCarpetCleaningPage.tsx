...
export default function HordenCarpetCleaningPage() {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      ...
      meta.content = "Professional carpet & upholstery cleaning in Horden. Steam cleaning & stain removal. Serving Peterlee, Easington, Shotton Colliery & County Durham. Book today.";
