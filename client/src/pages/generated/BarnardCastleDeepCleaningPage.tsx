...
export default function BarnardCastleDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Barnard Castle | Complete Property Restoration | County Durham";
  const pageDescription = "Professional deep cleaning in Barnard Castle. Complete property restoration & spring cleaning. Serving Bishop Auckland, Darlington & County Durham. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"barnard-castle"}`)}
        ogType="service"
