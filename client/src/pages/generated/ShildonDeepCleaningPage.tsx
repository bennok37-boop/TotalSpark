...
export default function ShildonDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Shildon | Complete Property Restoration | County Durham";
  const pageDescription = "Professional deep cleaning in Shildon. Complete property restoration & spring cleaning. Serving Newton Aycliffe, Bishop Auckland, Darlington & County Durham. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"shildon"}`)}
        ogType="service"
