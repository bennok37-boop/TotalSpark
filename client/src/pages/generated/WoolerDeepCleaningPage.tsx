...
export default function WoolerDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Wooler | Complete Property Restoration | Northumberland";
  const pageDescription = "Professional deep cleaning in Wooler. Complete property restoration & spring cleaning. Serving Berwick-upon-Tweed, Alnwick & Northumberland. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"wooler"}`)}
        ogType="service"
