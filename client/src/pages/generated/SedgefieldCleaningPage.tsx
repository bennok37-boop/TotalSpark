...
export default function SedgefieldCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Sedgefield | Regular & One-Off | County Durham";
  const pageDescription = "Professional cleaning services in Sedgefield. Regular domestic cleaning & one-off cleans. Serving Newton Aycliffe, Ferryhill, Stockton-on-Tees & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"sedgefield"}`)}
        ogType="service"
