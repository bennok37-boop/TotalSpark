...
export default function EstonCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Eston | Regular & One-Off | Tees Valley";
  const pageDescription = "Professional cleaning services in Eston. Regular domestic cleaning & one-off cleans. Serving Middlesbrough, Redcar, Grangetown & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"eston"}`)}
        ogType="service"
