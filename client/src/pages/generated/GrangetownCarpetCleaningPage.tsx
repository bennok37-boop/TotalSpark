...
export default function GrangetownCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Grangetown | Steam Cleaning Specialists | Tees Valley";
  const pageDescription = "Professional carpet & upholstery cleaning in Grangetown. Steam cleaning & stain removal. Serving Middlesbrough, Redcar, Eston & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"grangetown"}`)}
        ogType="service"
