...
export default function BishopAucklandCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Bishop Auckland | Office & Business Cleaning | County Durham";
  const pageDescription = "Professional commercial cleaning in Bishop Auckland. Office cleaning & business services. Serving Durham, Newton Aycliffe, Crook & County Durham businesses. Get quote today.";
  const cityName = "Bishop Auckland";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"bishop-auckland"}`)}
        ogType="service"
