...
export default function BlaydononTyneCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Blaydon-on-Tyne | Steam Cleaning Specialists | Tyne & Wear";
  const pageDescription = "Professional carpet & upholstery cleaning in Blaydon-on-Tyne. Steam cleaning & stain removal. Serving Gateshead, Prudhoe & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"blaydon-on-tyne"}`)}
        ogType="service"
