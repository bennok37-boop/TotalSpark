...
export default function GatesheadCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Gateshead | Regular & One-Off | Tyne & Wear";
  const pageDescription = "Professional cleaning services in Gateshead. Regular domestic cleaning & one-off cleans. Serving Newcastle upon Tyne, Blaydon-on-Tyne, Felling & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"gateshead"}`)}
        ogType="service"
