...
export default function WheatleyHillCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Wheatley Hill | Regular & One-Off | County Durham";
  const pageDescription = "Professional cleaning services in Wheatley Hill. Regular domestic cleaning & one-off cleans. Serving Shotton Colliery, Trimdon & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"wheatley-hill"}`)}
        ogType="service"
