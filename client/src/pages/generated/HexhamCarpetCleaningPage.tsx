...
export default function HexhamCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Hexham | Steam Cleaning Specialists | Northumberland";
  const pageDescription = "Professional carpet & upholstery cleaning in Hexham. Steam cleaning & stain removal. Serving Corbridge, Prudhoe, Haltwhistle & Northumberland. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"hexham"}`)}
        ogType="service"
