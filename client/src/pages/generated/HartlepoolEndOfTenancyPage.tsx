...
export default function HartlepoolEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Hartlepool | Deposit Back Guarantee | Tees Valley";
  const pageDescription = "Professional end of tenancy cleaning in Hartlepool. 100% deposit back guarantee. Serving Peterlee, Billingham & Tees Valley. Book online today.";
  const cityName = "Hartlepool";
