...
export default function SouthShieldsDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services South Shields | Complete Property Restoration | Tyne & Wear";
  const pageDescription = "Professional deep cleaning in South Shields. Complete property restoration & spring cleaning. Serving North Shields, Jarrow, Hebburn & Tyne & Wear. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"south-shields"}`)}
        ogType="service"
