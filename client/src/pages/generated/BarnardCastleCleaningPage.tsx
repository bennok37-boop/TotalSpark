...
export default function BarnardCastleCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Barnard Castle | Regular & One-Off | County Durham";
  const pageDescription = "Professional cleaning services in Barnard Castle. Regular domestic cleaning & one-off cleans. Serving Bishop Auckland, Darlington & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"barnard-castle"}`)}
        ogType="service"
