...
export default function BerwickuponTweedEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Berwick-upon-Tweed | Deposit Back Guarantee | Northumberland";
  const pageDescription = "Professional end of tenancy cleaning in Berwick-upon-Tweed. 100% deposit back guarantee. Serving Wooler & Northumberland. Book online today.";
  const cityName = "Berwick-upon-Tweed";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"berwick-upon-tweed"}`)}
        ogType="service"
