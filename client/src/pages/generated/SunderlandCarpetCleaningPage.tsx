...
export default function SunderlandCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Sunderland | Steam Cleaning Specialists | Tyne & Wear";
  const pageDescription = "Professional carpet & upholstery cleaning in Sunderland. Steam cleaning & stain removal. Serving Washington, Houghton-le-Spring, Seaham & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"sunderland"}`)}
        ogType="service"
