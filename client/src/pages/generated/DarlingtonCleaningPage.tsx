...
export default function DarlingtonCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Darlington | Regular & One-Off | Tees Valley";
  const pageDescription = "Professional cleaning services in Darlington. Regular domestic cleaning & one-off cleans. Serving Newton Aycliffe, Barnard Castle & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"darlington"}`)}
        ogType="service"
