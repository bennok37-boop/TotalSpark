...
export default function SaltburnbytheSeaDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Saltburn-by-the-Sea | Complete Property Restoration | Tees Valley";
  const pageDescription = "Professional deep cleaning in Saltburn-by-the-Sea. Complete property restoration & spring cleaning. Serving Redcar, Marske-by-the-Sea, Guisborough & Tees Valley. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"saltburn-by-the-sea"}`)}
        ogType="service"
