...
export default function NorthShieldsCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services North Shields | Regular & One-Off | Tyne & Wear";
  const pageDescription = "Professional cleaning services in North Shields. Regular domestic cleaning & one-off cleans. Serving Tynemouth, Whitley Bay, Wallsend & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"north-shields"}`)}
        ogType="service"
