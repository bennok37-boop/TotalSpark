...
export default function BillinghamCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Billingham | Steam Cleaning Specialists | Tees Valley";
  const pageDescription = "Professional carpet & upholstery cleaning in Billingham. Steam cleaning & stain removal. Serving Stockton-on-Tees, Norton & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"billingham"}`)}
        ogType="service"
