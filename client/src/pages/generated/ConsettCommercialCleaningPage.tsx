...
export default function ConsettCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Consett | Office & Business Cleaning | County Durham";
  const pageDescription = "Professional commercial cleaning in Consett. Office cleaning & business services. Serving Stanley, Durham, Hexham & County Durham businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"consett"}`)}
        ogType="service"
