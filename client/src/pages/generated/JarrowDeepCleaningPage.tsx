...
export default function JarrowDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Jarrow | Complete Property Restoration | Tyne & Wear";
  const pageDescription = "Professional deep cleaning in Jarrow. Complete property restoration & spring cleaning. Serving South Shields, Hebburn, Gateshead & Tyne & Wear. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"jarrow"}`)}
        ogType="service"
