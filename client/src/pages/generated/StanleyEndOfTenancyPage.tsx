...
export default function StanleyEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Stanley | Deposit Back Guarantee | County Durham";
  const pageDescription = "Professional end of tenancy cleaning in Stanley. 100% deposit back guarantee. Serving Consett, Chester-le-Street, Durham & County Durham. Book online today.";
  const cityName = "Stanley";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"stanley"}`)}
        ogType="service"
