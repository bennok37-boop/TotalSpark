...
export default function HebburnEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Hebburn | Deposit Back Guarantee | Tyne & Wear";
  const pageDescription = "Professional end of tenancy cleaning in Hebburn. 100% deposit back guarantee. Serving Jarrow, South Shields, Gateshead & Tyne & Wear. Book online today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"hebburn"}`)}
        ogType="service"
