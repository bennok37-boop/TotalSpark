...
export default function LoftusCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Loftus | Office & Business Cleaning | Tees Valley";
  const pageDescription = "Professional commercial cleaning in Loftus. Office cleaning & business services. Serving Saltburn-by-the-Sea, Easington & Tees Valley businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"loftus"}`)}
        ogType="service"
