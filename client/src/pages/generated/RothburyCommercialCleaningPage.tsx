...
export default function RothburyCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Rothbury | Office & Business Cleaning | Northumberland";
  const pageDescription = "Professional commercial cleaning in Rothbury. Office cleaning & business services. Serving Alnwick, Morpeth & Northumberland businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"rothbury"}`)}
        ogType="service"
