...
export default function WhitleyBayEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Whitley Bay | Deposit Back Guarantee | Tyne & Wear";
  const pageDescription = "Professional end of tenancy cleaning in Whitley Bay. 100% deposit back guarantee. Serving Tynemouth, North Shields, Blyth & Tyne & Wear. Book online today.";
  const cityName = "Whitley Bay";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"whitley-bay"}`)}
        ogType="service"
