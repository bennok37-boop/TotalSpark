...
export default function HartlepoolCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Hartlepool | Steam Cleaning Specialists | Tees Valley";
  const pageDescription = "Professional carpet & upholstery cleaning in Hartlepool. Steam cleaning & stain removal. Serving Peterlee, Billingham & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"hartlepool"}`)}
        ogType="service"
