...
export default function EasingtonCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Easington | Office & Business Cleaning | County Durham";
  const pageDescription = "Professional commercial cleaning in Easington. Office cleaning & business services. Serving Peterlee, Horden, Seaham & County Durham businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"easington"}`)}
        ogType="service"
