...
export default function WoolerCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Wooler | Steam Cleaning Specialists | Northumberland";
  const pageDescription = "Professional carpet & upholstery cleaning in Wooler. Steam cleaning & stain removal. Serving Berwick-upon-Tweed, Alnwick & Northumberland. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"wooler"}`)}
        ogType="service"
