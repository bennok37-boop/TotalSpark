...
export default function ConsettDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Consett | Complete Property Restoration | County Durham";
  const pageDescription = "Professional deep cleaning in Consett. Complete property restoration & spring cleaning. Serving Stanley, Durham, Hexham & County Durham. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"consett"}`)}
        ogType="service"
