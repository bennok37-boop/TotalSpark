...
export default function AlnwickCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Alnwick | Steam Cleaning Specialists | Northumberland";
  const pageDescription = "Professional carpet & upholstery cleaning in Alnwick. Steam cleaning & stain removal. Serving Amble, Rothbury, Seahouses & Northumberland. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"alnwick"}`)}
        ogType="service"
