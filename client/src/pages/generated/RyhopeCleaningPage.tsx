...
export default function RyhopeCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Ryhope | Regular & One-Off | Tyne & Wear";
  const pageDescription = "Professional cleaning services in Ryhope. Regular domestic cleaning & one-off cleans. Serving Sunderland, Seaham, Houghton-le-Spring & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"ryhope"}`)}
        ogType="service"
