...
export default function AmbleDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Amble | Complete Property Restoration | Northumberland";
  const pageDescription = "Professional deep cleaning in Amble. Complete property restoration & spring cleaning. Serving Alnwick, Seahouses & Northumberland. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"amble"}`)}
        ogType="service"
