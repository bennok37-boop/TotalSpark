...
export default function BarnardCastleEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Barnard Castle | Deposit Back Guarantee | County Durham";
  const pageDescription = "Professional end of tenancy cleaning in Barnard Castle. 100% deposit back guarantee. Serving Bishop Auckland, Darlington & County Durham. Book online today.";
  const cityName = "Barnard Castle";
