...
export default function HoughtonleSpringCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Houghton-le-Spring | Office & Business Cleaning | Tyne & Wear";
  const pageDescription = "Professional commercial cleaning in Houghton-le-Spring. Office cleaning & business services. Serving Sunderland, Washington, Chester-le-Street & Tyne & Wear businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"houghton-le-spring"}`)}
        ogType="service"
