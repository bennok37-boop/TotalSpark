...
export default function NewtonAycliffeCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Newton Aycliffe | Steam Cleaning Specialists | County Durham";
  const pageDescription = "Professional carpet & upholstery cleaning in Newton Aycliffe. Steam cleaning & stain removal. Serving Bishop Auckland, Darlington, Shildon & County Durham. Book today.";
