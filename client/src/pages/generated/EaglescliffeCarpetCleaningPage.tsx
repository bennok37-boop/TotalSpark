...
export default function EaglescliffeCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Eaglescliffe | Steam Cleaning Specialists | Tees Valley";
  const pageDescription = "Professional carpet & upholstery cleaning in Eaglescliffe. Steam cleaning & stain removal. Serving Yarm, Ingleby Barwick, Stockton-on-Tees & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"eaglescliffe"}`)}
        ogType="service"
