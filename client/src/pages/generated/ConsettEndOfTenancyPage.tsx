...
export default function ConsettEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Consett | Deposit Back Guarantee | County Durham";
  const pageDescription = "Professional end of tenancy cleaning in Consett. 100% deposit back guarantee. Serving Stanley, Durham, Hexham & County Durham. Book online today.";
  const cityName = "Consett";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"consett"}`)}
        ogType="service"
