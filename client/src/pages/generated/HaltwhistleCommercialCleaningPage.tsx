...
export default function HaltwhistleCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Haltwhistle | Office & Business Cleaning | Northumberland";
  const pageDescription = "Professional commercial cleaning in Haltwhistle. Office cleaning & business services. Serving Hexham & Northumberland businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"haltwhistle"}`)}
        ogType="service"
