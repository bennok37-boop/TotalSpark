...
export default function NortonEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Norton | Deposit Back Guarantee | Tees Valley";
  const pageDescription = "Professional end of tenancy cleaning in Norton. 100% deposit back guarantee. Serving Stockton-on-Tees, Billingham & Tees Valley. Book online today.";
  const cityName = "Norton";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"norton"}`)}
        ogType="service"
