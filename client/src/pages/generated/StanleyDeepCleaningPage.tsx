...
export default function StanleyDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Stanley | Complete Property Restoration | County Durham";
  const pageDescription = "Professional deep cleaning in Stanley. Complete property restoration & spring cleaning. Serving Consett, Chester-le-Street, Durham & County Durham. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"stanley"}`)}
        ogType="service"
