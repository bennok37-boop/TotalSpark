...
export default function BirtleyCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Birtley | Steam Cleaning Specialists | Tyne & Wear";
  const pageDescription = "Professional carpet & upholstery cleaning in Birtley. Steam cleaning & stain removal. Serving Gateshead, Washington, Chester-le-Street & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"birtley"}`)}
        ogType="service"
