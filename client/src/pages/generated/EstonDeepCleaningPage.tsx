...
export default function EstonDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Eston | Complete Property Restoration | Tees Valley";
  const pageDescription = "Professional deep cleaning in Eston. Complete property restoration & spring cleaning. Serving Middlesbrough, Redcar, Grangetown & Tees Valley. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"eston"}`)}
        ogType="service"
