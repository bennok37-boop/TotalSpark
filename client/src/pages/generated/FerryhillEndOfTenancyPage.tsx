...
export default function FerryhillEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Ferryhill | Deposit Back Guarantee | County Durham";
  const pageDescription = "Professional end of tenancy cleaning in Ferryhill. 100% deposit back guarantee. Serving Spennymoor, Sedgefield, Newton Aycliffe & County Durham. Book online today.";
  const cityName = "Ferryhill";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"ferryhill"}`)}
        ogType="service"
