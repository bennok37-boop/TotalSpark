...
export default function BirtleyDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Birtley | Complete Property Restoration | Tyne & Wear";
  const pageDescription = "Professional deep cleaning in Birtley. Complete property restoration & spring cleaning. Serving Gateshead, Washington, Chester-le-Street & Tyne & Wear. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"birtley"}`)}
        ogType="service"
