...
export default function FellingDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Felling | Complete Property Restoration | Tyne & Wear";
  const pageDescription = "Professional deep cleaning in Felling. Complete property restoration & spring cleaning. Serving Gateshead, Jarrow, Hebburn & Tyne & Wear. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"felling"}`)}
        ogType="service"
