...
export default function FellingDeepCleaningPage() {
  // Get tracking numbers for this location
  const trackingNumbers = useTrackingNumbers();
  
  // Set page title and meta description
  useEffect(() => {
    document.title = "Deep Cleaning Services Felling | Complete Property Restoration | Tyne & Wear";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', "Professional deep cleaning in Felling. Complete property restoration & spring cleaning. Serving Gateshead, Jarrow, Hebburn & Tyne & Wear. Transform your space.");
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = "Professional deep cleaning in Felling. Complete property restoration & spring cleaning. Serving Gateshead, Jarrow, Hebburn & Tyne & Wear. Transform your space.";
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <Badge variant="secondary" className="mb-4" data-testid="badge-service-type">
              {"Deep Cleaning"} in {"Felling"}
            </Badge>
            <h1 className="text-4xl lg:text-6xl font-bold mb-6 text-foreground" data-testid="text-hero-title">
              {"Deep Cleaning Services Felling – Complete Property Restoration"}
            </h1>
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed" data-testid="text-hero-subtitle">
              {"Comprehensive deep cleaning across Felling, Gateshead, Jarrow, Hebburn and surrounding Tyne & Wear areas. Perfect for neglected properties, spring cleaning, and property restoration."}
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-6 mt-8 text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-2" data-testid="text-trust-signal">
                ...
                <span>{"Property restoration experts in Felling"}</span>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4" data-testid="text-features-title">
                {"Deep Cleaning"} Services in {"Felling"}
              </h2>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4" data-testid="text-pricing-title">
                {"Deep Cleaning"} Prices in {"Felling"}
              </h2>
              <p className="text-lg text-muted-foreground">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">
                Common questions about {"deep cleaning"} in {"Felling"}
              </p>
            </div>
            ...
            <Accordion type="single" collapsible className="space-y-4" data-testid="accordion-faq">
              ...
              <AccordionItem value="item-0" className="border rounded-lg px-6">
                <AccordionTrigger className="text-left font-medium" data-testid="trigger-faq-0">
                  {"What does deep cleaning include in Felling?"}
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pt-2" data-testid="content-faq-0">
                  {"Our Felling deep cleaning covers every surface: kitchen appliances, bathroom descaling, carpet treatment, window cleaning, and detailed room-by-room restoration across Tyne & Wear."}
                </AccordionContent>
              </AccordionItem>
              
              <AccordionItem value="item-1" className="border rounded-lg px-6">
                <AccordionTrigger className="text-left font-medium" data-testid="trigger-faq-1">
                  {"How long does deep cleaning take in Felling?"}
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pt-2" data-testid="content-faq-1">
                  {"Felling deep cleaning typically takes 4-8 hours depending on property size and condition. We'll provide an accurate timeframe after assessment."}
                </AccordionContent>
              </AccordionItem>
              
              <AccordionItem value="item-2" className="border rounded-lg px-6">
                <AccordionTrigger className="text-left font-medium" data-testid="trigger-faq-2">
                  {"Do you clean neglected or vacant Felling properties?"}
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pt-2" data-testid="content-faq-2">
                  {"Yes, we specialize in restoring neglected and vacant properties across Felling and Tyne & Wear. No property is too challenging for our experienced team."}
                </AccordionContent>
              </AccordionItem>
              
              <AccordionItem value="item-3" className="border rounded-lg px-6">
                <AccordionTrigger className="text-left font-medium" data-testid="trigger-faq-3">
                  {"Can you remove stubborn stains and odors in Felling?"}
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pt-2" data-testid="content-faq-3">
                  {"Our Felling deep cleaning includes specialist stain removal, odor elimination, and restoration techniques. We tackle the toughest cleaning challenges across Tyne & Wear."}
                </AccordionContent>
              </AccordionItem>
              
              <AccordionItem value="item-4" className="border rounded-lg px-6">
                <AccordionTrigger className="text-left font-medium" data-testid="trigger-faq-4">
                  {"Do you offer one-off deep cleaning in Felling?"}
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pt-2" data-testid="content-faq-4">
                  {"Yes, most of our Felling deep cleaning is one-off service for property restoration, spring cleaning, or preparing for regular maintenance cleaning."}
                </AccordionContent>
              </AccordionItem>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">
                {"Deep Cleaning"} success stories from {"Felling"} and {"Tyne & Wear"}
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <Card className="text-center hover-elevate" data-testid="card-success-0">
                <CardContent className="p-6">
                  ...
                  <h3 className="font-semibold mb-2">{"Felling Property Restoration"}</h3>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4" data-testid="text-final-cta-title">
              Ready to Book {"Deep Cleaning"} in {"Felling"}?
            </h2>
