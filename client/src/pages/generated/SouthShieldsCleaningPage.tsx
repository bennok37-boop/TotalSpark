...
export default function SouthShieldsCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services South Shields | Regular & One-Off | Tyne & Wear";
  const pageDescription = "Professional cleaning services in South Shields. Regular domestic cleaning & one-off cleans. Serving North Shields, Jarrow, Hebburn & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"south-shields"}`)}
        ogType="service"
