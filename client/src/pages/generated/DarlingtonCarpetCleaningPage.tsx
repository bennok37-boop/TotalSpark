...
export default function DarlingtonCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Darlington | Steam Cleaning Specialists | Tees Valley";
  const pageDescription = "Professional carpet & upholstery cleaning in Darlington. Steam cleaning & stain removal. Serving Newton Aycliffe, Barnard Castle & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"darlington"}`)}
        ogType="service"
