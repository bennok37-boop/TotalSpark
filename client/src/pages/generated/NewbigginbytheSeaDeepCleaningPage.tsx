...
export default function NewbigginbytheSeaDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Newbiggin-by-the-Sea | Complete Property Restoration | Northumberland";
  const pageDescription = "Professional deep cleaning in Newbiggin-by-the-Sea. Complete property restoration & spring cleaning. Serving Ashington, Blyth & Northumberland. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"newbiggin-by-the-sea"}`)}
        ogType="service"
