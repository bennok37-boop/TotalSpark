...
export default function HordenEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Horden | Deposit Back Guarantee | County Durham";
  const pageDescription = "Professional end of tenancy cleaning in Horden. 100% deposit back guarantee. Serving Peterlee, Easington, Shotton Colliery & County Durham. Book online today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"horden"}`)}
        ogType="service"
