...
export default function EasingtonDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Easington | Complete Property Restoration | County Durham";
  const pageDescription = "Professional deep cleaning in Easington. Complete property restoration & spring cleaning. Serving Peterlee, Horden, Seaham & County Durham. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"easington"}`)}
        ogType="service"
