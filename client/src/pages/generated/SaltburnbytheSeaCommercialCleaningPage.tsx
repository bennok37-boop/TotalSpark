...
export default function SaltburnbytheSeaCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Saltburn-by-the-Sea | Office & Business Cleaning | Tees Valley";
  const pageDescription = "Professional commercial cleaning in Saltburn-by-the-Sea. Office cleaning & business services. Serving Redcar, Marske-by-the-Sea, Guisborough & Tees Valley businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"saltburn-by-the-sea"}`)}
        ogType="service"
