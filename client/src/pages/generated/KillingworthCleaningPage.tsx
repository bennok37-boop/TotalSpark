...
export default function KillingworthCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Killingworth | Regular & One-Off | Tyne & Wear";
  const pageDescription = "Professional cleaning services in Killingworth. Regular domestic cleaning & one-off cleans. Serving Wallsend, Longbenton, Cramlington & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"killingworth"}`)}
        ogType="service"
