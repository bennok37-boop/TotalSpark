...
export default function SunderlandDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Sunderland | Complete Property Restoration | Tyne & Wear";
  const pageDescription = "Professional deep cleaning in Sunderland. Complete property restoration & spring cleaning. Serving Washington, Houghton-le-Spring, Seaham & Tyne & Wear. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"sunderland"}`)}
        ogType="service"
