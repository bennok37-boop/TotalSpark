...
export default function SaltburnbytheSeaCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Saltburn-by-the-Sea | Regular & One-Off | Tees Valley";
  const pageDescription = "Professional cleaning services in Saltburn-by-the-Sea. Regular domestic cleaning & one-off cleans. Serving Redcar, Marske-by-the-Sea, Guisborough & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"saltburn-by-the-sea"}`)}
        ogType="service"
