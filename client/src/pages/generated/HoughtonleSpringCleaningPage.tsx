...
export default function HoughtonleSpringCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Houghton-le-Spring | Regular & One-Off | Tyne & Wear";
  const pageDescription = "Professional cleaning services in Houghton-le-Spring. Regular domestic cleaning & one-off cleans. Serving Sunderland, Washington, Chester-le-Street & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"houghton-le-spring"}`)}
        ogType="service"
