...
export default function GatesheadEndOfTenancyPage() {
  // Get tracking numbers for this location
  const trackingNumbers = useTrackingNumbers();
  
  // Set page title and meta description
  useEffect(() => {
    document.title = "End of Tenancy Cleaning Gateshead | Deposit Back Guarantee | Tyne & Wear";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', "Professional end of tenancy cleaning in Gateshead. 100% deposit back guarantee. Serving Newcastle upon Tyne, Blaydon-on-Tyne, Felling & Tyne & Wear. Book online today.");
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = "Professional end of tenancy cleaning in Gateshead. 100% deposit back guarantee. Serving Newcastle upon Tyne, Blaydon-on-Tyne, Felling & Tyne & Wear. Book online today.";
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <Badge variant="secondary" className="mb-4" data-testid="badge-service-type">
              {"End of Tenancy Cleaning"} in {"Gateshead"}
            </Badge>
            <h1 className="text-4xl lg:text-6xl font-bold mb-6 text-foreground" data-testid="text-hero-title">
              {"End of Tenancy Cleaning Gateshead – 100% Deposit Back Guarantee"}
            </h1>
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed" data-testid="text-hero-subtitle">
              {"Professional end of tenancy cleaning across Gateshead, Newcastle upon Tyne, Blaydon-on-Tyne, Felling and surrounding Tyne & Wear areas. Get your full deposit back or we'll re-clean free."}
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-6 mt-8 text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-2" data-testid="text-trust-signal">
                ...
                <span>{"Gateshead Deposit Guarantee - 100% money back"}</span>
              </div>
              ...
              <div className="flex items-center gap-2" data-testid="text-trust-signal">
                <CheckCircle className="h-4 w-4 text-primary" />
                <span>{"24-48hr service available in Gateshead"}</span>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4" data-testid="text-features-title">
                {"End of Tenancy Cleaning"} Services in {"Gateshead"}
              </h2>
              <p className="text-lg text-muted-foreground">
                Professional cleaning services across {"Gateshead"} and surrounding {"Tyne & Wear"} areas
              </p>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4" data-testid="text-pricing-title">
                {"End of Tenancy Cleaning"} Prices in {"Gateshead"}
              </h2>
              <p className="text-lg text-muted-foreground">
                Transparent pricing for {"Gateshead"} properties
              </p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Card className="hover-elevate" data-testid="card-pricing-0">
                <CardHeader className="text-center">
                  ...
                  <CardDescription>{"Perfect for Gateshead centre studios"}</CardDescription>
                </CardHeader>
              ...
              <Card className="hover-elevate" data-testid="card-pricing-2">
                <CardHeader className="text-center">
                  ...
                  <CardDescription>{"Common in Gateshead areas"}</CardDescription>
                </CardHeader>
                <CardContent className="text-center">
              ...
              <Card className="hover-elevate" data-testid="card-pricing-4">
                <CardHeader className="text-center">
                  ...
                  <CardDescription>{"Large Gateshead properties"}</CardDescription>
                </CardHeader>
                <CardContent className="text-center">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">
                Common questions about {"end of tenancy cleaning"} in {"Gateshead"}
              </p>
            </div>
            ...
            <Accordion type="single" collapsible className="space-y-4" data-testid="accordion-faq">
              ...
              <AccordionItem value="item-0" className="border rounded-lg px-6">
                <AccordionTrigger className="text-left font-medium" data-testid="trigger-faq-0">
                  {"Do you guarantee my deposit back in Gateshead?"}
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pt-2" data-testid="content-faq-0">
                  {"Absolutely — if your Gateshead landlord or letting agent raises an issue with the cleaning, we'll re-clean within 48 hours completely free of charge. This guarantee covers all Gateshead areas and Tyne & Wear."}
                </AccordionContent>
              </AccordionItem>
              
              <AccordionItem value="item-1" className="border rounded-lg px-6">
                <AccordionTrigger className="text-left font-medium" data-testid="trigger-faq-1">
                  {"Which Gateshead letting agents do you work with?"}
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pt-2" data-testid="content-faq-1">
                  {"We regularly work with major Tyne & Wear letting agents and have extensive experience with Gateshead property management companies. Our cleaning meets industry standards."}
                </AccordionContent>
              </AccordionItem>
              
              <AccordionItem value="item-2" className="border rounded-lg px-6">
                <AccordionTrigger className="text-left font-medium" data-testid="trigger-faq-2">
                  {"Can you clean student properties in Gateshead?"}
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pt-2" data-testid="content-faq-2">
                  {"Yes! We specialize in Gateshead student properties and HMOs. We understand the specific requirements for student house move-outs in the Tyne & Wear area."}
                </AccordionContent>
              </AccordionItem>
              
              <AccordionItem value="item-3" className="border rounded-lg px-6">
                <AccordionTrigger className="text-left font-medium" data-testid="trigger-faq-3">
                  {"How quickly can you clean my Gateshead property?"}
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pt-2" data-testid="content-faq-3">
                  {"We often arrange Gateshead end of tenancy cleaning within 24-48 hours. Same-day emergency cleaning may be available for urgent Gateshead move-outs."}
                </AccordionContent>
              </AccordionItem>
              
              <AccordionItem value="item-4" className="border rounded-lg px-6">
                <AccordionTrigger className="text-left font-medium" data-testid="trigger-faq-4">
                  {"Do you bring equipment to Gateshead properties?"}
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pt-2" data-testid="content-faq-4">
                  {"Yes, all professional cleaning equipment and eco-friendly products are brought to your Gateshead property. No need to provide anything."}
                </AccordionContent>
              </AccordionItem>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">
                {"End of Tenancy Cleaning"} success stories from {"Gateshead"} and {"Tyne & Wear"}
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <Card className="text-center hover-elevate" data-testid="card-success-0">
                <CardContent className="p-6">
                  ...
                  <h3 className="font-semibold mb-2">{"Gateshead Student House"}</h3>
              ...
              <Card className="text-center hover-elevate" data-testid="card-success-1">
                <CardContent className="p-6">
                  <Star className="h-8 w-8 text-primary mx-auto mb-4" />
                  <h3 className="font-semibold mb-2">{"Newcastle upon Tyne Flat"}</h3>
              ...
              <Card className="text-center hover-elevate" data-testid="card-success-2">
                <CardContent className="p-6">
                  <Star className="h-8 w-8 text-primary mx-auto mb-4" />
                  <h3 className="font-semibold mb-2">{"Blaydon-on-Tyne Family Home"}</h3>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4" data-testid="text-final-cta-title">
              Ready to Book {"End of Tenancy Cleaning"} in {"Gateshead"}?
            </h2>
