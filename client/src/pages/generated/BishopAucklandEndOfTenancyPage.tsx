...
export default function BishopAucklandEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Bishop Auckland | Deposit Back Guarantee | County Durham";
  const pageDescription = "Professional end of tenancy cleaning in Bishop Auckland. 100% deposit back guarantee. Serving Durham, Newton Aycliffe, Crook & County Durham. Book online today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"bishop-auckland"}`)}
        ogType="service"
