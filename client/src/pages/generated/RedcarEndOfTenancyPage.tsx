...
export default function RedcarEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Redcar | Deposit Back Guarantee | Tees Valley";
  const pageDescription = "Professional end of tenancy cleaning in Redcar. 100% deposit back guarantee. Serving Middlesbrough, Saltburn-by-the-Sea, Marske-by-the-Sea & Tees Valley. Book online today.";
  const cityName = "Redcar";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"redcar"}`)}
        ogType="service"
