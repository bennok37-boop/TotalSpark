...
export default function RothburyCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Rothbury | Steam Cleaning Specialists | Northumberland";
  const pageDescription = "Professional carpet & upholstery cleaning in Rothbury. Steam cleaning & stain removal. Serving Alnwick, Morpeth & Northumberland. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"rothbury"}`)}
        ogType="service"
