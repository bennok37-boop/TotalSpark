...
export default function BoldonEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Boldon | Deposit Back Guarantee | Tyne & Wear";
  const pageDescription = "Professional end of tenancy cleaning in Boldon. 100% deposit back guarantee. Serving South Shields, Sunderland, Washington & Tyne & Wear. Book online today.";
  const cityName = "Boldon";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"boldon"}`)}
        ogType="service"
