...
export default function NorthShieldsDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services North Shields | Complete Property Restoration | Tyne & Wear";
  const pageDescription = "Professional deep cleaning in North Shields. Complete property restoration & spring cleaning. Serving Tynemouth, Whitley Bay, Wallsend & Tyne & Wear. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"north-shields"}`)}
        ogType="service"
