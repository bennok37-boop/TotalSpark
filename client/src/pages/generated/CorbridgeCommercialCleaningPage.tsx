...
export default function CorbridgeCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Corbridge | Office & Business Cleaning | Northumberland";
  const pageDescription = "Professional commercial cleaning in Corbridge. Office cleaning & business services. Serving Hexham, Prudhoe & Northumberland businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"corbridge"}`)}
        ogType="service"
