...
export default function CrookCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Crook | Office & Business Cleaning | County Durham";
  const pageDescription = "Professional commercial cleaning in Crook. Office cleaning & business services. Serving Bishop Auckland, Spennymoor & County Durham businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"crook"}`)}
        ogType="service"
