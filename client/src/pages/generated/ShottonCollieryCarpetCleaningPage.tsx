...
export default function ShottonCollieryCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Shotton Colliery | Steam Cleaning Specialists | County Durham";
  const pageDescription = "Professional carpet & upholstery cleaning in Shotton Colliery. Steam cleaning & stain removal. Serving Horden, Easington, Peterlee & County Durham. Book today.";
