...
export default function EaglescliffeEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Eaglescliffe | Deposit Back Guarantee | Tees Valley";
  const pageDescription = "Professional end of tenancy cleaning in Eaglescliffe. 100% deposit back guarantee. Serving Yarm, Ingleby Barwick, Stockton-on-Tees & Tees Valley. Book online today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"eaglescliffe"}`)}
        ogType="service"
