...
export default function AshingtonCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Ashington | Regular & One-Off | Northumberland";
  const pageDescription = "Professional cleaning services in Ashington. Regular domestic cleaning & one-off cleans. Serving Blyth, Morpeth, Newbiggin-by-the-Sea & Northumberland. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"ashington"}`)}
        ogType="service"
