...
export default function EasingtonCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Easington | Regular & One-Off | County Durham";
  const pageDescription = "Professional cleaning services in Easington. Regular domestic cleaning & one-off cleans. Serving Peterlee, Horden, Seaham & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"easington"}`)}
        ogType="service"
