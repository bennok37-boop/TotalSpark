...
export default function InglebyBarwickEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Ingleby Barwick | Deposit Back Guarantee | Tees Valley";
  const pageDescription = "Professional end of tenancy cleaning in Ingleby Barwick. 100% deposit back guarantee. Serving Thornaby, Yarm, Stockton-on-Tees & Tees Valley. Book online today.";
  const cityName = "Ingleby Barwick";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"ingleby-barwick"}`)}
        ogType="service"
