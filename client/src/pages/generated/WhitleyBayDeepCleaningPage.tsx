...
export default function WhitleyBayDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Whitley Bay | Complete Property Restoration | Tyne & Wear";
  const pageDescription = "Professional deep cleaning in Whitley Bay. Complete property restoration & spring cleaning. Serving Tynemouth, North Shields, Blyth & Tyne & Wear. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"whitley-bay"}`)}
        ogType="service"
