...
export default function SunderlandEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Sunderland | Deposit Back Guarantee | Tyne & Wear";
  const pageDescription = "Professional end of tenancy cleaning in Sunderland. 100% deposit back guarantee. Serving Washington, Houghton-le-Spring, Seaham & Tyne & Wear. Book online today.";
