...
export default function StanleyCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Stanley | Office & Business Cleaning | County Durham";
  const pageDescription = "Professional commercial cleaning in Stanley. Office cleaning & business services. Serving Consett, Chester-le-Street, Durham & County Durham businesses. Get quote today.";
