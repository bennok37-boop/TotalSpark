...
export default function BishopAucklandDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Bishop Auckland | Complete Property Restoration | County Durham";
  const pageDescription = "Professional deep cleaning in Bishop Auckland. Complete property restoration & spring cleaning. Serving Durham, Newton Aycliffe, Crook & County Durham. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"bishop-auckland"}`)}
        ogType="service"
