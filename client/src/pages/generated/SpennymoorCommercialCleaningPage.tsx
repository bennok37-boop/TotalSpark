...
export default function SpennymoorCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Spennymoor | Office & Business Cleaning | County Durham";
  const pageDescription = "Professional commercial cleaning in Spennymoor. Office cleaning & business services. Serving Bishop Auckland, Durham, Ferryhill & County Durham businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"spennymoor"}`)}
        ogType="service"
