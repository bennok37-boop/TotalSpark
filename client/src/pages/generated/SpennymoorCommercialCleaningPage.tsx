...
export default function SpennymoorCommercialCleaningPage() {
  // Get tracking numbers for this location
  const trackingNumbers = useTrackingNumbers();
  
  // Set page title and meta description
  useEffect(() => {
    document.title = "Commercial Cleaning Services Spennymoor | Office & Business Cleaning | County Durham";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', "Professional commercial cleaning in Spennymoor. Office cleaning & business services. Serving Bishop Auckland, Durham, Ferryhill & County Durham businesses. Get quote today.");
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = "Professional commercial cleaning in Spennymoor. Office cleaning & business services. Serving Bishop Auckland, Durham, Ferryhill & County Durham businesses. Get quote today.";
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <Badge variant="secondary" className="mb-4" data-testid="badge-service-type">
              {"Commercial Cleaning"} in {"Spennymoor"}
            </Badge>
            <h1 className="text-4xl lg:text-6xl font-bold mb-6 text-foreground" data-testid="text-hero-title">
              {"Commercial Cleaning Services Spennymoor – Office & Business Cleaning"}
            </h1>
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed" data-testid="text-hero-subtitle">
              {"Professional commercial cleaning across Spennymoor, Bishop Auckland, Durham, Ferryhill and surrounding County Durham business areas. Daily, weekly, and contract cleaning services."}
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-6 mt-8 text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-2" data-testid="text-trust-signal">
                ...
                <span>{"Trusted by Spennymoor businesses"}</span>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4" data-testid="text-features-title">
                {"Commercial Cleaning"} Services in {"Spennymoor"}
              </h2>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4" data-testid="text-pricing-title">
                {"Commercial Cleaning"} Prices in {"Spennymoor"}
              </h2>
              <p className="text-lg text-muted-foreground">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">
                Common questions about {"commercial cleaning"} in {"Spennymoor"}
              </p>
            </div>
            ...
            <Accordion type="single" collapsible className="space-y-4" data-testid="accordion-faq">
              ...
              <AccordionItem value="item-0" className="border rounded-lg px-6">
                <AccordionTrigger className="text-left font-medium" data-testid="trigger-faq-0">
                  {"What commercial cleaning services do you offer in Spennymoor?"}
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pt-2" data-testid="content-faq-0">
                  {"We provide office cleaning, retail cleaning, industrial cleaning, and specialist commercial services across Spennymoor and County Durham business districts."}
                </AccordionContent>
              </AccordionItem>
              
              <AccordionItem value="item-1" className="border rounded-lg px-6">
                <AccordionTrigger className="text-left font-medium" data-testid="trigger-faq-1">
                  {"Can you clean Spennymoor offices outside business hours?"}
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pt-2" data-testid="content-faq-1">
                  {"Yes, we offer flexible scheduling including evenings, weekends, and early mornings to suit your Spennymoor business operations without disruption."}
                </AccordionContent>
              </AccordionItem>
              
              <AccordionItem value="item-2" className="border rounded-lg px-6">
                <AccordionTrigger className="text-left font-medium" data-testid="trigger-faq-2">
                  {"Do you provide cleaning contracts for Spennymoor businesses?"}
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pt-2" data-testid="content-faq-2">
                  {"We offer daily, weekly, monthly, and bespoke cleaning contracts for Spennymoor businesses. All contracts include regular quality checks and account management."}
                </AccordionContent>
              </AccordionItem>
              
              <AccordionItem value="item-3" className="border rounded-lg px-6">
                <AccordionTrigger className="text-left font-medium" data-testid="trigger-faq-3">
                  {"Are you insured for commercial cleaning in Spennymoor?"}
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pt-2" data-testid="content-faq-3">
                  {"Yes, we carry comprehensive commercial insurance including public liability and employer liability for all Spennymoor and County Durham commercial work."}
                </AccordionContent>
              </AccordionItem>
              
              <AccordionItem value="item-4" className="border rounded-lg px-6">
                <AccordionTrigger className="text-left font-medium" data-testid="trigger-faq-4">
                  {"Can you handle large Spennymoor commercial properties?"}
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pt-2" data-testid="content-faq-4">
                  {"We have experience with properties of all sizes across Spennymoor and County Durham, from small offices to large industrial facilities and retail spaces."}
                </AccordionContent>
              </AccordionItem>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">
                {"Commercial Cleaning"} success stories from {"Spennymoor"} and {"County Durham"}
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <Card className="text-center hover-elevate" data-testid="card-success-0">
                <CardContent className="p-6">
                  ...
                  <h3 className="font-semibold mb-2">{"Spennymoor Office Complex"}</h3>
              ...
              <Card className="text-center hover-elevate" data-testid="card-success-2">
                <CardContent className="p-6">
                  <Star className="h-8 w-8 text-primary mx-auto mb-4" />
                  <h3 className="font-semibold mb-2">{"Durham Business Park"}</h3>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4" data-testid="text-final-cta-title">
              Ready to Book {"Commercial Cleaning"} in {"Spennymoor"}?
            </h2>
