...
export default function EstonEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Eston | Deposit Back Guarantee | Tees Valley";
  const pageDescription = "Professional end of tenancy cleaning in Eston. 100% deposit back guarantee. Serving Middlesbrough, Redcar, Grangetown & Tees Valley. Book online today.";
  const cityName = "Eston";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"eston"}`)}
        ogType="service"
