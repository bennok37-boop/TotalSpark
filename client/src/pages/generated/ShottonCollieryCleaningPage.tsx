...
export default function ShottonCollieryCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Shotton Colliery | Regular & One-Off | County Durham";
  const pageDescription = "Professional cleaning services in Shotton Colliery. Regular domestic cleaning & one-off cleans. Serving Horden, Easington, Peterlee & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"shotton-colliery"}`)}
        ogType="service"
