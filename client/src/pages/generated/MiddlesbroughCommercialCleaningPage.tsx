...
export default function MiddlesbroughCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Middlesbrough | Office & Business Cleaning | Tees Valley";
  const pageDescription = "Professional commercial cleaning in Middlesbrough. Office cleaning & business services. Serving Stockton-on-Tees, Redcar, Thornaby & Tees Valley businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"middlesbrough"}`)}
        ogType="service"
