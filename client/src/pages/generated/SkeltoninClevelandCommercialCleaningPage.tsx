...
export default function SkeltoninClevelandCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Skelton-in-Cleveland | Office & Business Cleaning | Tees Valley";
  const pageDescription = "Professional commercial cleaning in Skelton-in-Cleveland. Office cleaning & business services. Serving Guisborough, Saltburn-by-the-Sea & Tees Valley businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"skelton-in-cleveland"}`)}
        ogType="service"
