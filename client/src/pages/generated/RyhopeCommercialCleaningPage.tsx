...
export default function RyhopeCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Ryhope | Office & Business Cleaning | Tyne & Wear";
  const pageDescription = "Professional commercial cleaning in Ryhope. Office cleaning & business services. Serving Sunderland, Seaham, Houghton-le-Spring & Tyne & Wear businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"ryhope"}`)}
        ogType="service"
