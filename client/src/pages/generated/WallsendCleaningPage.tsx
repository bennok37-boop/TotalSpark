...
export default function WallsendCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Wallsend | Regular & One-Off | Tyne & Wear";
  const pageDescription = "Professional cleaning services in Wallsend. Regular domestic cleaning & one-off cleans. Serving North Shields, Tynemouth, Longbenton & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"wallsend"}`)}
        ogType="service"
