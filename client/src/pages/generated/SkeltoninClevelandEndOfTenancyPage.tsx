...
export default function SkeltoninClevelandEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Skelton-in-Cleveland | Deposit Back Guarantee | Tees Valley";
  const pageDescription = "Professional end of tenancy cleaning in Skelton-in-Cleveland. 100% deposit back guarantee. Serving Guisborough, Saltburn-by-the-Sea & Tees Valley. Book online today.";
  const cityName = "Skelton-in-Cleveland";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"skelton-in-cleveland"}`)}
        ogType="service"
