...
export default function HexhamCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Hexham | Office & Business Cleaning | Northumberland";
  const pageDescription = "Professional commercial cleaning in Hexham. Office cleaning & business services. Serving Corbridge, Prudhoe, Haltwhistle & Northumberland businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"hexham"}`)}
        ogType="service"
