...
export default function BishopAucklandCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Bishop Auckland | Steam Cleaning Specialists | County Durham";
  const pageDescription = "Professional carpet & upholstery cleaning in Bishop Auckland. Steam cleaning & stain removal. Serving Durham, Newton Aycliffe, Crook & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"bishop-auckland"}`)}
        ogType="service"
