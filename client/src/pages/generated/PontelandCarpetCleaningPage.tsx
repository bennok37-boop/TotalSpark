...
export default function PontelandCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Ponteland | Steam Cleaning Specialists | Northumberland";
  const pageDescription = "Professional carpet & upholstery cleaning in Ponteland. Steam cleaning & stain removal. Serving Cramlington, Morpeth, Newcastle upon Tyne & Northumberland. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"ponteland"}`)}
        ogType="service"
