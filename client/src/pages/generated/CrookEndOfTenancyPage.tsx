...
export default function CrookEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Crook | Deposit Back Guarantee | County Durham";
  const pageDescription = "Professional end of tenancy cleaning in Crook. 100% deposit back guarantee. Serving Bishop Auckland, Spennymoor & County Durham. Book online today.";
  const cityName = "Crook";
