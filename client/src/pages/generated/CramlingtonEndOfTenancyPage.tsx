...
export default function CramlingtonEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Cramlington | Deposit Back Guarantee | Northumberland";
  const pageDescription = "Professional end of tenancy cleaning in Cramlington. 100% deposit back guarantee. Serving Blyth, Morpeth, Ponteland & Northumberland. Book online today.";
  const cityName = "Cramlington";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"cramlington"}`)}
        ogType="service"
