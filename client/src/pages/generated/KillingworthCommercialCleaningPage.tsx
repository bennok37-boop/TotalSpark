...
export default function KillingworthCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Killingworth | Office & Business Cleaning | Tyne & Wear";
  const pageDescription = "Professional commercial cleaning in Killingworth. Office cleaning & business services. Serving Wallsend, Longbenton, Cramlington & Tyne & Wear businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"killingworth"}`)}
        ogType="service"
