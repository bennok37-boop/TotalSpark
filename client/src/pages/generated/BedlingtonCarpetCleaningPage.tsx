...
export default function BedlingtonCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Bedlington | Steam Cleaning Specialists | Northumberland";
  const pageDescription = "Professional carpet & upholstery cleaning in Bedlington. Steam cleaning & stain removal. Serving Ashington, Cramlington, Blyth & Northumberland. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"bedlington"}`)}
        ogType="service"
