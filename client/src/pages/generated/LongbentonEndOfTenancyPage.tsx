...
export default function LongbentonEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Longbenton | Deposit Back Guarantee | Tyne & Wear";
  const pageDescription = "Professional end of tenancy cleaning in Longbenton. 100% deposit back guarantee. Serving Wallsend, Killingworth & Tyne & Wear. Book online today.";
  const cityName = "Longbenton";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"longbenton"}`)}
        ogType="service"
