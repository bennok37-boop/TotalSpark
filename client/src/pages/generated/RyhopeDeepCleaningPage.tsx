...
export default function RyhopeDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Ryhope | Complete Property Restoration | Tyne & Wear";
  const pageDescription = "Professional deep cleaning in Ryhope. Complete property restoration & spring cleaning. Serving Sunderland, Seaham, Houghton-le-Spring & Tyne & Wear. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"ryhope"}`)}
        ogType="service"
