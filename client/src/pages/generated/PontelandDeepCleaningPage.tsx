...
export default function PontelandDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Ponteland | Complete Property Restoration | Northumberland";
  const pageDescription = "Professional deep cleaning in Ponteland. Complete property restoration & spring cleaning. Serving Cramlington, Morpeth, Newcastle upon Tyne & Northumberland. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"ponteland"}`)}
        ogType="service"
