...
export default function InglebyBarwickDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Ingleby Barwick | Complete Property Restoration | Tees Valley";
  const pageDescription = "Professional deep cleaning in Ingleby Barwick. Complete property restoration & spring cleaning. Serving Thornaby, Yarm, Stockton-on-Tees & Tees Valley. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"ingleby-barwick"}`)}
        ogType="service"
