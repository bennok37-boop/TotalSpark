...
export default function PrudhoeDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Prudhoe | Complete Property Restoration | Northumberland";
  const pageDescription = "Professional deep cleaning in Prudhoe. Complete property restoration & spring cleaning. Serving Hexham, Corbridge, Blaydon-on-Tyne & Northumberland. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"prudhoe"}`)}
        ogType="service"
