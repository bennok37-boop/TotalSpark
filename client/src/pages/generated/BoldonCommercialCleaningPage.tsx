...
export default function BoldonCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Boldon | Office & Business Cleaning | Tyne & Wear";
  const pageDescription = "Professional commercial cleaning in Boldon. Office cleaning & business services. Serving South Shields, Sunderland, Washington & Tyne & Wear businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"boldon"}`)}
        ogType="service"
