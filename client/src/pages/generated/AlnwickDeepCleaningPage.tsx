...
export default function AlnwickDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Alnwick | Complete Property Restoration | Northumberland";
  const pageDescription = "Professional deep cleaning in Alnwick. Complete property restoration & spring cleaning. Serving Amble, Rothbury, Seahouses & Northumberland. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"alnwick"}`)}
        ogType="service"
