...
export default function RothburyDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Rothbury | Complete Property Restoration | Northumberland";
  const pageDescription = "Professional deep cleaning in Rothbury. Complete property restoration & spring cleaning. Serving Alnwick, Morpeth & Northumberland. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"rothbury"}`)}
        ogType="service"
