...
export default function FellingCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Felling | Steam Cleaning Specialists | Tyne & Wear";
  const pageDescription = "Professional carpet & upholstery cleaning in Felling. Steam cleaning & stain removal. Serving Gateshead, Jarrow, Hebburn & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"felling"}`)}
        ogType="service"
