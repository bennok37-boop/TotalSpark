...
export default function LongbentonCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Longbenton | Regular & One-Off | Tyne & Wear";
  const pageDescription = "Professional cleaning services in Longbenton. Regular domestic cleaning & one-off cleans. Serving Wallsend, Killingworth & Tyne & Wear. Book today.";
