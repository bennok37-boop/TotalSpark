...
export default function MiddlesbroughEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Middlesbrough | Deposit Back Guarantee | Tees Valley";
  const pageDescription = "Professional end of tenancy cleaning in Middlesbrough. 100% deposit back guarantee. Serving Stockton-on-Tees, Redcar, Thornaby & Tees Valley. Book online today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"middlesbrough"}`)}
        ogType="service"
