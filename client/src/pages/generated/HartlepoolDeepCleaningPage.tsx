...
export default function HartlepoolDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Hartlepool | Complete Property Restoration | Tees Valley";
  const pageDescription = "Professional deep cleaning in Hartlepool. Complete property restoration & spring cleaning. Serving Peterlee, Billingham & Tees Valley. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"hartlepool"}`)}
        ogType="service"
