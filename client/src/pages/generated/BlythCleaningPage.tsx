...
export default function BlythCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Blyth | Regular & One-Off | Northumberland";
  const pageDescription = "Professional cleaning services in Blyth. Regular domestic cleaning & one-off cleans. Serving Ashington, Cramlington, Whitley Bay & Northumberland. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"blyth"}`)}
        ogType="service"
