...
export default function InglebyBarwickCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Ingleby Barwick | Regular & One-Off | Tees Valley";
  const pageDescription = "Professional cleaning services in Ingleby Barwick. Regular domestic cleaning & one-off cleans. Serving Thornaby, Yarm, Stockton-on-Tees & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"ingleby-barwick"}`)}
        ogType="service"
