...
export default function ThornabyCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Thornaby | Regular & One-Off | Tees Valley";
  const pageDescription = "Professional cleaning services in Thornaby. Regular domestic cleaning & one-off cleans. Serving Stockton-on-Tees, Middlesbrough, Yarm & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"thornaby"}`)}
        ogType="service"
