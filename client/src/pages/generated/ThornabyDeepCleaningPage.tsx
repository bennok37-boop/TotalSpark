...
export default function ThornabyDeepCleaningPage() {
  ...
  useEffect(() => {
    document.title = "Deep Cleaning Services Thornaby | Complete Property Restoration | Tees Valley";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', "Professional deep cleaning in Thornaby. Complete property restoration & spring cleaning. Serving Stockton-on-Tees, Middlesbrough, Yarm & Tees Valley. Transform your space.");
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = "Professional deep cleaning in Thornaby. Complete property restoration & spring cleaning. Serving Stockton-on-Tees, Middlesbrough, Yarm & Tees Valley. Transform your space.";
