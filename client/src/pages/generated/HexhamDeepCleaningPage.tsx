...
export default function HexhamDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Hexham | Complete Property Restoration | Northumberland";
  const pageDescription = "Professional deep cleaning in Hexham. Complete property restoration & spring cleaning. Serving Corbridge, Prudhoe, Haltwhistle & Northumberland. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"hexham"}`)}
        ogType="service"
