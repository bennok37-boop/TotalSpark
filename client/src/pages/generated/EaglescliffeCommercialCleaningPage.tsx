...
export default function EaglescliffeCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Eaglescliffe | Office & Business Cleaning | Tees Valley";
  const pageDescription = "Professional commercial cleaning in Eaglescliffe. Office cleaning & business services. Serving Yarm, Ingleby Barwick, Stockton-on-Tees & Tees Valley businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"eaglescliffe"}`)}
        ogType="service"
