...
export default function YarmCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Yarm | Office & Business Cleaning | Tees Valley";
  const pageDescription = "Professional commercial cleaning in Yarm. Office cleaning & business services. Serving Stockton-on-Tees, Ingleby Barwick, Eaglescliffe & Tees Valley businesses. Get quote today.";
  const cityName = "Yarm";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"yarm"}`)}
        ogType="service"
