...
export default function PeterleeCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Peterlee | Regular & One-Off | County Durham";
  const pageDescription = "Professional cleaning services in Peterlee. Regular domestic cleaning & one-off cleans. Serving Seaham, Hartlepool, Easington & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"peterlee"}`)}
        ogType="service"
