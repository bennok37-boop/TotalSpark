...
export default function SunderlandCleaningPage() {
  ...
  useEffect(() => {
    document.title = "Professional Cleaning Services Sunderland | Regular & One-Off | Tyne & Wear";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', "Professional cleaning services in Sunderland. Regular domestic cleaning & one-off cleans. Serving Washington, Houghton-le-Spring, Seaham & Tyne & Wear. Book today.");
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = "Professional cleaning services in Sunderland. Regular domestic cleaning & one-off cleans. Serving Washington, Houghton-le-Spring, Seaham & Tyne & Wear. Book today.";
