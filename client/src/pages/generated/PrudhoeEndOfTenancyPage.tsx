...
export default function PrudhoeEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Prudhoe | Deposit Back Guarantee | Northumberland";
  const pageDescription = "Professional end of tenancy cleaning in Prudhoe. 100% deposit back guarantee. Serving Hexham, Corbridge, Blaydon-on-Tyne & Northumberland. Book online today.";
  const cityName = "Prudhoe";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"prudhoe"}`)}
        ogType="service"
