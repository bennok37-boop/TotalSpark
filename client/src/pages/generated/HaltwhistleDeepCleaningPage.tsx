...
export default function HaltwhistleDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Haltwhistle | Complete Property Restoration | Northumberland";
  const pageDescription = "Professional deep cleaning in Haltwhistle. Complete property restoration & spring cleaning. Serving Hexham & Northumberland. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"haltwhistle"}`)}
        ogType="service"
