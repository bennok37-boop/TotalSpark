...
export default function PontelandCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Ponteland | Regular & One-Off | Northumberland";
  const pageDescription = "Professional cleaning services in Ponteland. Regular domestic cleaning & one-off cleans. Serving Cramlington, Morpeth, Newcastle upon Tyne & Northumberland. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"ponteland"}`)}
        ogType="service"
