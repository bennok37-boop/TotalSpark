...
export default function AmbleEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Amble | Deposit Back Guarantee | Northumberland";
  const pageDescription = "Professional end of tenancy cleaning in Amble. 100% deposit back guarantee. Serving Alnwick, Seahouses & Northumberland. Book online today.";
  const cityName = "Amble";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"amble"}`)}
        ogType="service"
