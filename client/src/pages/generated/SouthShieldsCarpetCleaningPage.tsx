...
export default function SouthShieldsCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning South Shields | Steam Cleaning Specialists | Tyne & Wear";
  const pageDescription = "Professional carpet & upholstery cleaning in South Shields. Steam cleaning & stain removal. Serving North Shields, Jarrow, Hebburn & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"south-shields"}`)}
        ogType="service"
