...
export default function WoolerEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Wooler | Deposit Back Guarantee | Northumberland";
  const pageDescription = "Professional end of tenancy cleaning in Wooler. 100% deposit back guarantee. Serving Berwick-upon-Tweed, Alnwick & Northumberland. Book online today.";
  const cityName = "Wooler";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"wooler"}`)}
        ogType="service"
