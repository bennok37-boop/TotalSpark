...
export default function NortonCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Norton | Office & Business Cleaning | Tees Valley";
  const pageDescription = "Professional commercial cleaning in Norton. Office cleaning & business services. Serving Stockton-on-Tees, Billingham & Tees Valley businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"norton"}`)}
        ogType="service"
