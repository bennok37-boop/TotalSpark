...
export default function WoolerCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Wooler | Regular & One-Off | Northumberland";
  const pageDescription = "Professional cleaning services in Wooler. Regular domestic cleaning & one-off cleans. Serving Berwick-upon-Tweed, Alnwick & Northumberland. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"wooler"}`)}
        ogType="service"
