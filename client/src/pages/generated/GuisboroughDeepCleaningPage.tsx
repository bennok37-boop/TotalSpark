...
export default function GuisboroughDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Guisborough | Complete Property Restoration | Tees Valley";
  const pageDescription = "Professional deep cleaning in Guisborough. Complete property restoration & spring cleaning. Serving Saltburn-by-the-Sea, Skelton-in-Cleveland & Tees Valley. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"guisborough"}`)}
        ogType="service"
