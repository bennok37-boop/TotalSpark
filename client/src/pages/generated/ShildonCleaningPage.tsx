...
export default function ShildonCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Shildon | Regular & One-Off | County Durham";
  const pageDescription = "Professional cleaning services in Shildon. Regular domestic cleaning & one-off cleans. Serving Newton Aycliffe, Bishop Auckland, Darlington & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"shildon"}`)}
        ogType="service"
