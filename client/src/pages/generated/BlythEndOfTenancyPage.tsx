...
export default function BlythEndOfTenancyPage() {
  ...
  useEffect(() => {
    document.title = "End of Tenancy Cleaning Blyth | Deposit Back Guarantee | Northumberland";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', "Professional end of tenancy cleaning in Blyth. 100% deposit back guarantee. Serving Ashington, Cramlington, Whitley Bay & Northumberland. Book online today.");
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = "Professional end of tenancy cleaning in Blyth. 100% deposit back guarantee. Serving Ashington, Cramlington, Whitley Bay & Northumberland. Book online today.";
