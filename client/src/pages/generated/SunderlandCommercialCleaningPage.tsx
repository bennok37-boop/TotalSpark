...
export default function SunderlandCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Sunderland | Office & Business Cleaning | Tyne & Wear";
  const pageDescription = "Professional commercial cleaning in Sunderland. Office cleaning & business services. Serving Washington, Houghton-le-Spring, Seaham & Tyne & Wear businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"sunderland"}`)}
        ogType="service"
