...
export default function KillingworthCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Killingworth | Steam Cleaning Specialists | Tyne & Wear";
  const pageDescription = "Professional carpet & upholstery cleaning in Killingworth. Steam cleaning & stain removal. Serving Wallsend, Longbenton, Cramlington & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"killingworth"}`)}
        ogType="service"
