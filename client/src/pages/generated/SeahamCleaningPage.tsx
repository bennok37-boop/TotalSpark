...
export default function SeahamCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Seaham | Regular & One-Off | County Durham";
  const pageDescription = "Professional cleaning services in Seaham. Regular domestic cleaning & one-off cleans. Serving Sunderland, Houghton-le-Spring, Peterlee & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"seaham"}`)}
        ogType="service"
