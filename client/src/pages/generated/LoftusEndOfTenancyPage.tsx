...
export default function LoftusEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Loftus | Deposit Back Guarantee | Tees Valley";
  const pageDescription = "Professional end of tenancy cleaning in Loftus. 100% deposit back guarantee. Serving Saltburn-by-the-Sea, Easington & Tees Valley. Book online today.";
  const cityName = "Loftus";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"loftus"}`)}
        ogType="service"
