...
export default function HaltwhistleCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Haltwhistle | Regular & One-Off | Northumberland";
  const pageDescription = "Professional cleaning services in Haltwhistle. Regular domestic cleaning & one-off cleans. Serving Hexham & Northumberland. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"haltwhistle"}`)}
        ogType="service"
