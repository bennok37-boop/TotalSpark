...
export default function GuisboroughCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Guisborough | Regular & One-Off | Tees Valley";
  const pageDescription = "Professional cleaning services in Guisborough. Regular domestic cleaning & one-off cleans. Serving Saltburn-by-the-Sea, Skelton-in-Cleveland & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"guisborough"}`)}
        ogType="service"
