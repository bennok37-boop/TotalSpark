...
export default function PeterleeEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Peterlee | Deposit Back Guarantee | County Durham";
  const pageDescription = "Professional end of tenancy cleaning in Peterlee. 100% deposit back guarantee. Serving Seaham, Hartlepool, Easington & County Durham. Book online today.";
  const cityName = "Peterlee";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"peterlee"}`)}
        ogType="service"
