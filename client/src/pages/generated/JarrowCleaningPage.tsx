...
export default function JarrowCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Jarrow | Regular & One-Off | Tyne & Wear";
  const pageDescription = "Professional cleaning services in Jarrow. Regular domestic cleaning & one-off cleans. Serving South Shields, Hebburn, Gateshead & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"jarrow"}`)}
        ogType="service"
