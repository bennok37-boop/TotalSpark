...
export default function WashingtonCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Washington | Regular & One-Off | Tyne & Wear";
  const pageDescription = "Professional cleaning services in Washington. Regular domestic cleaning & one-off cleans. Serving Sunderland, Houghton-le-Spring, Chester-le-Street & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"washington"}`)}
        ogType="service"
