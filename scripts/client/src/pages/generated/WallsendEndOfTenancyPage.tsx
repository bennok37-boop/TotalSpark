...
export default function WallsendEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Wallsend | Deposit Back Guarantee | Tyne & Wear";
  const pageDescription = "Professional end of tenancy cleaning in Wallsend. 100% deposit back guarantee. Serving North Shields, Tynemouth, Longbenton & Tyne & Wear. Book online today.";
  const cityName = "Wallsend";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"wallsend"}`)}
        ogType="service"
