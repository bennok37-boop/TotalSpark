...
export default function RothburyEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Rothbury | Deposit Back Guarantee | Northumberland";
  const pageDescription = "Professional end of tenancy cleaning in Rothbury. 100% deposit back guarantee. Serving Alnwick, Morpeth & Northumberland. Book online today.";
  const cityName = "Rothbury";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"rothbury"}`)}
        ogType="service"
