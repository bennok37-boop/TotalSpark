...
export default function SeahamEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Seaham | Deposit Back Guarantee | County Durham";
  const pageDescription = "Professional end of tenancy cleaning in Seaham. 100% deposit back guarantee. Serving Sunderland, Houghton-le-Spring, Peterlee & County Durham. Book online today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"seaham"}`)}
        ogType="service"
