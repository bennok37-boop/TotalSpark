...
export default function SouthShieldsEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning South Shields | Deposit Back Guarantee | Tyne & Wear";
  const pageDescription = "Professional end of tenancy cleaning in South Shields. 100% deposit back guarantee. Serving North Shields, Jarrow, Hebburn & Tyne & Wear. Book online today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"south-shields"}`)}
        ogType="service"
