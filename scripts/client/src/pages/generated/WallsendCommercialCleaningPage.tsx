...
export default function WallsendCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Wallsend | Office & Business Cleaning | Tyne & Wear";
  const pageDescription = "Professional commercial cleaning in Wallsend. Office cleaning & business services. Serving North Shields, Tynemouth, Longbenton & Tyne & Wear businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"wallsend"}`)}
        ogType="service"
