...
export default function EaglescliffeCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Eaglescliffe | Regular & One-Off | Tees Valley";
  const pageDescription = "Professional cleaning services in Eaglescliffe. Regular domestic cleaning & one-off cleans. Serving Yarm, Ingleby Barwick, Stockton-on-Tees & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"eaglescliffe"}`)}
        ogType="service"
