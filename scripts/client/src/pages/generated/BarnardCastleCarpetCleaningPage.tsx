...
export default function BarnardCastleCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Barnard Castle | Steam Cleaning Specialists | County Durham";
  const pageDescription = "Professional carpet & upholstery cleaning in Barnard Castle. Steam cleaning & stain removal. Serving Bishop Auckland, Darlington & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"barnard-castle"}`)}
        ogType="service"
