...
export default function GrangetownDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Grangetown | Complete Property Restoration | Tees Valley";
  const pageDescription = "Professional deep cleaning in Grangetown. Complete property restoration & spring cleaning. Serving Middlesbrough, Redcar, Eston & Tees Valley. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"grangetown"}`)}
        ogType="service"
