...
export default function EasingtonCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Easington | Steam Cleaning Specialists | County Durham";
  const pageDescription = "Professional carpet & upholstery cleaning in Easington. Steam cleaning & stain removal. Serving Peterlee, Horden, Seaham & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"easington"}`)}
        ogType="service"
