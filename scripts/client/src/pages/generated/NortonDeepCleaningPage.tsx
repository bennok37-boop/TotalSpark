...
export default function NortonDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Norton | Complete Property Restoration | Tees Valley";
  const pageDescription = "Professional deep cleaning in Norton. Complete property restoration & spring cleaning. Serving Stockton-on-Tees, Billingham & Tees Valley. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"norton"}`)}
        ogType="service"
