...
export default function StocktononTeesEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Stockton-on-Tees | Deposit Back Guarantee | Tees Valley";
  const pageDescription = "Professional end of tenancy cleaning in Stockton-on-Tees. 100% deposit back guarantee. Serving Middlesbrough, Thornaby, Billingham & Tees Valley. Book online today.";
  const cityName = "Stockton-on-Tees";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"stockton-on-tees"}`)}
        ogType="service"
