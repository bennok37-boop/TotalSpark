...
export default function NewtonAycliffeCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Newton Aycliffe | Regular & One-Off | County Durham";
  const pageDescription = "Professional cleaning services in Newton Aycliffe. Regular domestic cleaning & one-off cleans. Serving Bishop Auckland, Darlington, Shildon & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"newton-aycliffe"}`)}
        ogType="service"
