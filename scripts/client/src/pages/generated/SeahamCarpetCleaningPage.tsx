...
export default function SeahamCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Seaham | Steam Cleaning Specialists | County Durham";
  const pageDescription = "Professional carpet & upholstery cleaning in Seaham. Steam cleaning & stain removal. Serving Sunderland, Houghton-le-Spring, Peterlee & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"seaham"}`)}
        ogType="service"
