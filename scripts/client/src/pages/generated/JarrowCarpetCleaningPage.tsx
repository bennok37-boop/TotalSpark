...
export default function JarrowCarpetCleaningPage() {
  // Get tracking numbers for this location
  const trackingNumbers = useTrackingNumbers();
  
  // Set page title and meta description
  useEffect(() => {
    document.title = "Carpet & Upholstery Cleaning Jarrow | Steam Cleaning Specialists | Tyne & Wear";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', "Professional carpet & upholstery cleaning in Jarrow. Steam cleaning & stain removal. Serving South Shields, Hebburn, Gateshead & Tyne & Wear. Book today.");
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = "Professional carpet & upholstery cleaning in Jarrow. Steam cleaning & stain removal. Serving South Shields, Hebburn, Gateshead & Tyne & Wear. Book today.";
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <Badge variant="secondary" className="mb-4" data-testid="badge-service-type">
              {"Carpet & Upholstery Cleaning"} in {"Jarrow"}
            </Badge>
            <h1 className="text-4xl lg:text-6xl font-bold mb-6 text-foreground" data-testid="text-hero-title">
              {"Carpet & Upholstery Cleaning Jarrow – Steam Cleaning Specialists"}
            </h1>
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed" data-testid="text-hero-subtitle">
              {"Professional carpet and upholstery cleaning across Jarrow, South Shields, Hebburn, Gateshead and surrounding Tyne & Wear areas. Steam cleaning, stain removal, and fabric protection."}
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-6 mt-8 text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-2" data-testid="text-trust-signal">
                ...
                <span>{"Carpet specialists serving Jarrow"}</span>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4" data-testid="text-features-title">
                {"Carpet & Upholstery Cleaning"} Services in {"Jarrow"}
              </h2>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4" data-testid="text-pricing-title">
                {"Carpet & Upholstery Cleaning"} Prices in {"Jarrow"}
              </h2>
              <p className="text-lg text-muted-foreground">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">
                Common questions about {"carpet & upholstery cleaning"} in {"Jarrow"}
              </p>
            </div>
            ...
            <Accordion type="single" collapsible className="space-y-4" data-testid="accordion-faq">
              ...
              <AccordionItem value="item-0" className="border rounded-lg px-6">
                <AccordionTrigger className="text-left font-medium" data-testid="trigger-faq-0">
                  {"What carpet cleaning methods do you use in Jarrow?"}
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pt-2" data-testid="content-faq-0">
                  {"We use professional steam cleaning and hot water extraction methods in Jarrow. This ensures deep cleaning while being safe for all carpet types across Tyne & Wear."}
                </AccordionContent>
              </AccordionItem>
              
              <AccordionItem value="item-1" className="border rounded-lg px-6">
                <AccordionTrigger className="text-left font-medium" data-testid="trigger-faq-1">
                  {"Can you remove pet stains and odors in Jarrow?"}
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pt-2" data-testid="content-faq-1">
                  {"Yes, we specialize in pet stain and odor removal using enzyme treatments and deep extraction methods. Our Jarrow service covers all types of pet-related carpet issues."}
                </AccordionContent>
              </AccordionItem>
              
              <AccordionItem value="item-2" className="border rounded-lg px-6">
                <AccordionTrigger className="text-left font-medium" data-testid="trigger-faq-2">
                  {"How long does carpet cleaning take in Jarrow?"}
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pt-2" data-testid="content-faq-2">
                  {"Jarrow carpet cleaning typically takes 1-3 hours depending on room size and soil level. Carpets are usually dry within 2-6 hours."}
                </AccordionContent>
              </AccordionItem>
              
              <AccordionItem value="item-3" className="border rounded-lg px-6">
                <AccordionTrigger className="text-left font-medium" data-testid="trigger-faq-3">
                  {"Do you clean upholstery and sofas in Jarrow?"}
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pt-2" data-testid="content-faq-3">
                  {"Yes, we clean all types of upholstery including sofas, chairs, curtains, and mattresses across Jarrow and Tyne & Wear using appropriate methods for each fabric type."}
                </AccordionContent>
              </AccordionItem>
              
              <AccordionItem value="item-4" className="border rounded-lg px-6">
                <AccordionTrigger className="text-left font-medium" data-testid="trigger-faq-4">
                  {"Can you protect carpets after cleaning in Jarrow?"}
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pt-2" data-testid="content-faq-4">
                  {"We offer fabric protection treatments for carpets and upholstery in Jarrow. This helps prevent future staining and extends the life of your furnishings."}
                </AccordionContent>
              </AccordionItem>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">
                {"Carpet & Upholstery Cleaning"} success stories from {"Jarrow"} and {"Tyne & Wear"}
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <Card className="text-center hover-elevate" data-testid="card-success-2">
                <CardContent className="p-6">
                  <Star className="h-8 w-8 text-primary mx-auto mb-4" />
                  <h3 className="font-semibold mb-2">{"Hebburn Rental"}</h3>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4" data-testid="text-final-cta-title">
              Ready to Book {"Carpet & Upholstery Cleaning"} in {"Jarrow"}?
            </h2>
