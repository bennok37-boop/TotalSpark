...
export default function BlaydononTyneDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Blaydon-on-Tyne | Complete Property Restoration | Tyne & Wear";
  const pageDescription = "Professional deep cleaning in Blaydon-on-Tyne. Complete property restoration & spring cleaning. Serving Gateshead, Prudhoe & Tyne & Wear. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"blaydon-on-tyne"}`)}
        ogType="service"
