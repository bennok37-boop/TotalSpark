...
export default function StocktononTeesCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Stockton-on-Tees | Steam Cleaning Specialists | Tees Valley";
  const pageDescription = "Professional carpet & upholstery cleaning in Stockton-on-Tees. Steam cleaning & stain removal. Serving Middlesbrough, Thornaby, Billingham & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"stockton-on-tees"}`)}
        ogType="service"
