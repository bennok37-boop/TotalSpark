...
export default function NorthShieldsEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning North Shields | Deposit Back Guarantee | Tyne & Wear";
  const pageDescription = "Professional end of tenancy cleaning in North Shields. 100% deposit back guarantee. Serving Tynemouth, Whitley Bay, Wallsend & Tyne & Wear. Book online today.";
  const cityName = "North Shields";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"north-shields"}`)}
        ogType="service"
