...
export default function TrimdonEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Trimdon | Deposit Back Guarantee | County Durham";
  const pageDescription = "Professional end of tenancy cleaning in Trimdon. 100% deposit back guarantee. Serving Sedgefield, Ferryhill & County Durham. Book online today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"trimdon"}`)}
        ogType="service"
