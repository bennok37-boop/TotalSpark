...
export default function RyhopeCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Ryhope | Steam Cleaning Specialists | Tyne & Wear";
  const pageDescription = "Professional carpet & upholstery cleaning in Ryhope. Steam cleaning & stain removal. Serving Sunderland, Seaham, Houghton-le-Spring & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"ryhope"}`)}
        ogType="service"
