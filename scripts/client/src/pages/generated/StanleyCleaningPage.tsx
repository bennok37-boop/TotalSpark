...
export default function StanleyCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Stanley | Regular & One-Off | County Durham";
  const pageDescription = "Professional cleaning services in Stanley. Regular domestic cleaning & one-off cleans. Serving Consett, Chester-le-Street, Durham & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"stanley"}`)}
        ogType="service"
