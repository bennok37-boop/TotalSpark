...
export default function SeahousesCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Seahouses | Office & Business Cleaning | Northumberland";
  const pageDescription = "Professional commercial cleaning in Seahouses. Office cleaning & business services. Serving Alnwick, Amble & Northumberland businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"seahouses"}`)}
        ogType="service"
