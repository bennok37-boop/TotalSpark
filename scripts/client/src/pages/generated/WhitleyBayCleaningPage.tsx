...
export default function WhitleyBayCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Whitley Bay | Regular & One-Off | Tyne & Wear";
  const pageDescription = "Professional cleaning services in Whitley Bay. Regular domestic cleaning & one-off cleans. Serving Tynemouth, North Shields, Blyth & Tyne & Wear. Book today.";
