...
export default function SeahousesCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Seahouses | Regular & One-Off | Northumberland";
  const pageDescription = "Professional cleaning services in Seahouses. Regular domestic cleaning & one-off cleans. Serving Alnwick, Amble & Northumberland. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"seahouses"}`)}
        ogType="service"
