...
export default function NewbigginbytheSeaEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Newbiggin-by-the-Sea | Deposit Back Guarantee | Northumberland";
  const pageDescription = "Professional end of tenancy cleaning in Newbiggin-by-the-Sea. 100% deposit back guarantee. Serving Ashington, Blyth & Northumberland. Book online today.";
  const cityName = "Newbiggin-by-the-Sea";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"newbiggin-by-the-sea"}`)}
        ogType="service"
