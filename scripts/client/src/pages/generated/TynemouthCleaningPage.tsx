...
export default function TynemouthCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Tynemouth | Regular & One-Off | Tyne & Wear";
  const pageDescription = "Professional cleaning services in Tynemouth. Regular domestic cleaning & one-off cleans. Serving North Shields, Whitley Bay, South Shields & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"tynemouth"}`)}
        ogType="service"
