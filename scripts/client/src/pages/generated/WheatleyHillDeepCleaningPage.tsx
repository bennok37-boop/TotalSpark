...
export default function WheatleyHillDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Wheatley Hill | Complete Property Restoration | County Durham";
  const pageDescription = "Professional deep cleaning in Wheatley Hill. Complete property restoration & spring cleaning. Serving Shotton Colliery, Trimdon & County Durham. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"wheatley-hill"}`)}
        ogType="service"
