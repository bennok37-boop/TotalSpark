...
export default function ThornabyEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Thornaby | Deposit Back Guarantee | Tees Valley";
  const pageDescription = "Professional end of tenancy cleaning in Thornaby. 100% deposit back guarantee. Serving Stockton-on-Tees, Middlesbrough, Yarm & Tees Valley. Book online today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"thornaby"}`)}
        ogType="service"
