...
export default function NewtonAycliffeCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Newton Aycliffe | Office & Business Cleaning | County Durham";
  const pageDescription = "Professional commercial cleaning in Newton Aycliffe. Office cleaning & business services. Serving Bishop Auckland, Darlington, Shildon & County Durham businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"newton-aycliffe"}`)}
        ogType="service"
