...
export default function WheatleyHillEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Wheatley Hill | Deposit Back Guarantee | County Durham";
  const pageDescription = "Professional end of tenancy cleaning in Wheatley Hill. 100% deposit back guarantee. Serving Shotton Colliery, Trimdon & County Durham. Book online today.";
  const cityName = "Wheatley Hill";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"wheatley-hill"}`)}
        ogType="service"
