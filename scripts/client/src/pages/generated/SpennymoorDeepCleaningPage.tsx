...
export default function SpennymoorDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Spennymoor | Complete Property Restoration | County Durham";
  const pageDescription = "Professional deep cleaning in Spennymoor. Complete property restoration & spring cleaning. Serving Bishop Auckland, Durham, Ferryhill & County Durham. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"spennymoor"}`)}
        ogType="service"
