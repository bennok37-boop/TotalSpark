...
export default function ChesterleStreetCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Chester-le-Street | Office & Business Cleaning | County Durham";
  const pageDescription = "Professional commercial cleaning in Chester-le-Street. Office cleaning & business services. Serving Durham, Washington, Stanley & County Durham businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"chester-le-street"}`)}
        ogType="service"
