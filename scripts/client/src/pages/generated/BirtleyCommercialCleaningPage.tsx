...
export default function BirtleyCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Birtley | Office & Business Cleaning | Tyne & Wear";
  const pageDescription = "Professional commercial cleaning in Birtley. Office cleaning & business services. Serving Gateshead, Washington, Chester-le-Street & Tyne & Wear businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"birtley"}`)}
        ogType="service"
