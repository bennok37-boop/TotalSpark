...
export default function ConsettCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Consett | Regular & One-Off | County Durham";
  const pageDescription = "Professional cleaning services in Consett. Regular domestic cleaning & one-off cleans. Serving Stanley, Durham, Hexham & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"consett"}`)}
        ogType="service"
