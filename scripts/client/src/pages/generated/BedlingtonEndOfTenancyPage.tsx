...
export default function BedlingtonEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Bedlington | Deposit Back Guarantee | Northumberland";
  const pageDescription = "Professional end of tenancy cleaning in Bedlington. 100% deposit back guarantee. Serving Ashington, Cramlington, Blyth & Northumberland. Book online today.";
  const cityName = "Bedlington";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"bedlington"}`)}
        ogType="service"
