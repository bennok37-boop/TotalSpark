...
export default function TrimdonCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Trimdon | Regular & One-Off | County Durham";
  const pageDescription = "Professional cleaning services in Trimdon. Regular domestic cleaning & one-off cleans. Serving Sedgefield, Ferryhill & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"trimdon"}`)}
        ogType="service"
