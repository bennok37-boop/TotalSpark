...
export default function ThornabyCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Thornaby | Office & Business Cleaning | Tees Valley";
  const pageDescription = "Professional commercial cleaning in Thornaby. Office cleaning & business services. Serving Stockton-on-Tees, Middlesbrough, Yarm & Tees Valley businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"thornaby"}`)}
        ogType="service"
