...
export default function HaltwhistleCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Haltwhistle | Steam Cleaning Specialists | Northumberland";
  const pageDescription = "Professional carpet & upholstery cleaning in Haltwhistle. Steam cleaning & stain removal. Serving Hexham & Northumberland. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"haltwhistle"}`)}
        ogType="service"
