...
export default function BerwickuponTweedCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Berwick-upon-Tweed | Office & Business Cleaning | Northumberland";
  const pageDescription = "Professional commercial cleaning in Berwick-upon-Tweed. Office cleaning & business services. Serving Wooler & Northumberland businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"berwick-upon-tweed"}`)}
        ogType="service"
