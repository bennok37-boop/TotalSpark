...
export default function AshingtonDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Ashington | Complete Property Restoration | Northumberland";
  const pageDescription = "Professional deep cleaning in Ashington. Complete property restoration & spring cleaning. Serving Blyth, Morpeth, Newbiggin-by-the-Sea & Northumberland. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"ashington"}`)}
        ogType="service"
