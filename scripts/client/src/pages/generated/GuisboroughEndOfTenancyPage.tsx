...
export default function GuisboroughEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Guisborough | Deposit Back Guarantee | Tees Valley";
  const pageDescription = "Professional end of tenancy cleaning in Guisborough. 100% deposit back guarantee. Serving Saltburn-by-the-Sea, Skelton-in-Cleveland & Tees Valley. Book online today.";
  const cityName = "Guisborough";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"guisborough"}`)}
        ogType="service"
