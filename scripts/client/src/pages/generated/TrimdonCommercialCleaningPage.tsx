...
export default function TrimdonCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Trimdon | Office & Business Cleaning | County Durham";
  const pageDescription = "Professional commercial cleaning in Trimdon. Office cleaning & business services. Serving Sedgefield, Ferryhill & County Durham businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"trimdon"}`)}
        ogType="service"
