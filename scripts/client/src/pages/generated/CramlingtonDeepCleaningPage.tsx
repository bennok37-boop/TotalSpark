...
export default function CramlingtonDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Cramlington | Complete Property Restoration | Northumberland";
  const pageDescription = "Professional deep cleaning in Cramlington. Complete property restoration & spring cleaning. Serving Blyth, Morpeth, Ponteland & Northumberland. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"cramlington"}`)}
        ogType="service"
