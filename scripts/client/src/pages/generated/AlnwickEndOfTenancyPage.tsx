...
export default function AlnwickEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Alnwick | Deposit Back Guarantee | Northumberland";
  const pageDescription = "Professional end of tenancy cleaning in Alnwick. 100% deposit back guarantee. Serving Amble, Rothbury, Seahouses & Northumberland. Book online today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"alnwick"}`)}
        ogType="service"
