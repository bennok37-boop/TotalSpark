...
export default function AmbleCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Amble | Steam Cleaning Specialists | Northumberland";
  const pageDescription = "Professional carpet & upholstery cleaning in Amble. Steam cleaning & stain removal. Serving Alnwick, Seahouses & Northumberland. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"amble"}`)}
        ogType="service"
