...
export default function HartlepoolCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Hartlepool | Regular & One-Off | Tees Valley";
  const pageDescription = "Professional cleaning services in Hartlepool. Regular domestic cleaning & one-off cleans. Serving Peterlee, Billingham & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"hartlepool"}`)}
        ogType="service"
