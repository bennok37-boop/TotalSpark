...
export default function SpennymoorEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Spennymoor | Deposit Back Guarantee | County Durham";
  const pageDescription = "Professional end of tenancy cleaning in Spennymoor. 100% deposit back guarantee. Serving Bishop Auckland, Durham, Ferryhill & County Durham. Book online today.";
  const cityName = "Spennymoor";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"spennymoor"}`)}
        ogType="service"
