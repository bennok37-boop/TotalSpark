...
export default function HordenCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Horden | Regular & One-Off | County Durham";
  const pageDescription = "Professional cleaning services in Horden. Regular domestic cleaning & one-off cleans. Serving Peterlee, Easington, Shotton Colliery & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"horden"}`)}
        ogType="service"
