...
export default function MarskebytheSeaDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Marske-by-the-Sea | Complete Property Restoration | Tees Valley";
  const pageDescription = "Professional deep cleaning in Marske-by-the-Sea. Complete property restoration & spring cleaning. Serving Redcar, Saltburn-by-the-Sea & Tees Valley. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"marske-by-the-sea"}`)}
        ogType="service"
