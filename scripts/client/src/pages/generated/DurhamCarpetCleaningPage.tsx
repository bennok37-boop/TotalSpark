...
export default function DurhamCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Durham | Steam Cleaning Specialists | County Durham";
  const pageDescription = "Professional carpet & upholstery cleaning in Durham. Steam cleaning & stain removal. Serving Chester-le-Street, Bishop Auckland, Consett & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"durham"}`)}
        ogType="service"
