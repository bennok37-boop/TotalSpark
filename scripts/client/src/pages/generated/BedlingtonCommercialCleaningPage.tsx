...
export default function BedlingtonCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Bedlington | Office & Business Cleaning | Northumberland";
  const pageDescription = "Professional commercial cleaning in Bedlington. Office cleaning & business services. Serving Ashington, Cramlington, Blyth & Northumberland businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"bedlington"}`)}
        ogType="service"
