...
export default function GrangetownEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Grangetown | Deposit Back Guarantee | Tees Valley";
  const pageDescription = "Professional end of tenancy cleaning in Grangetown. 100% deposit back guarantee. Serving Middlesbrough, Redcar, Eston & Tees Valley. Book online today.";
  const cityName = "Grangetown";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"grangetown"}`)}
        ogType="service"
