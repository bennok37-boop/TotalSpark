...
export default function GatesheadEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Gateshead | Deposit Back Guarantee | Tyne & Wear";
  const pageDescription = "Professional end of tenancy cleaning in Gateshead. 100% deposit back guarantee. Serving Newcastle upon Tyne, Blaydon-on-Tyne, Felling & Tyne & Wear. Book online today.";
  const cityName = "Gateshead";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"gateshead"}`)}
        ogType="service"
