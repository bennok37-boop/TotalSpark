...
export default function SeahousesEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Seahouses | Deposit Back Guarantee | Northumberland";
  const pageDescription = "Professional end of tenancy cleaning in Seahouses. 100% deposit back guarantee. Serving Alnwick, Amble & Northumberland. Book online today.";
  const cityName = "Seahouses";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"seahouses"}`)}
        ogType="service"
