...
export default function CrookCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Crook | Steam Cleaning Specialists | County Durham";
  const pageDescription = "Professional carpet & upholstery cleaning in Crook. Steam cleaning & stain removal. Serving Bishop Auckland, Spennymoor & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"crook"}`)}
        ogType="service"
