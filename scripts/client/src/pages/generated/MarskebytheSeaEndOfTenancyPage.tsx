...
export default function MarskebytheSeaEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Marske-by-the-Sea | Deposit Back Guarantee | Tees Valley";
  const pageDescription = "Professional end of tenancy cleaning in Marske-by-the-Sea. 100% deposit back guarantee. Serving Redcar, Saltburn-by-the-Sea & Tees Valley. Book online today.";
  const cityName = "Marske-by-the-Sea";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"marske-by-the-sea"}`)}
        ogType="service"
