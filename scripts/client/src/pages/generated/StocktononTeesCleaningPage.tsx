...
export default function StocktononTeesCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Stockton-on-Tees | Regular & One-Off | Tees Valley";
  const pageDescription = "Professional cleaning services in Stockton-on-Tees. Regular domestic cleaning & one-off cleans. Serving Middlesbrough, Thornaby, Billingham & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"stockton-on-tees"}`)}
        ogType="service"
