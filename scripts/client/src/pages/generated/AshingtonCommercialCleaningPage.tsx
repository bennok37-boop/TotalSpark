...
export default function AshingtonCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Ashington | Office & Business Cleaning | Northumberland";
  const pageDescription = "Professional commercial cleaning in Ashington. Office cleaning & business services. Serving Blyth, Morpeth, Newbiggin-by-the-Sea & Northumberland businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"ashington"}`)}
        ogType="service"
