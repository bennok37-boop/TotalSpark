...
export default function HordenDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Horden | Complete Property Restoration | County Durham";
  const pageDescription = "Professional deep cleaning in Horden. Complete property restoration & spring cleaning. Serving Peterlee, Easington, Shotton Colliery & County Durham. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"horden"}`)}
        ogType="service"
