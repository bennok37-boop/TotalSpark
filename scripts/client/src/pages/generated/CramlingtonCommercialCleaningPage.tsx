...
export default function CramlingtonCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Cramlington | Office & Business Cleaning | Northumberland";
  const pageDescription = "Professional commercial cleaning in Cramlington. Office cleaning & business services. Serving Blyth, Morpeth, Ponteland & Northumberland businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"cramlington"}`)}
        ogType="service"
