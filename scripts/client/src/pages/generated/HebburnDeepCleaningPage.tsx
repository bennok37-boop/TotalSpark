...
export default function HebburnDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Hebburn | Complete Property Restoration | Tyne & Wear";
  const pageDescription = "Professional deep cleaning in Hebburn. Complete property restoration & spring cleaning. Serving Jarrow, South Shields, Gateshead & Tyne & Wear. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"hebburn"}`)}
        ogType="service"
