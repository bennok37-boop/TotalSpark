...
export default function BoldonCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Boldon | Steam Cleaning Specialists | Tyne & Wear";
  const pageDescription = "Professional carpet & upholstery cleaning in Boldon. Steam cleaning & stain removal. Serving South Shields, Sunderland, Washington & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"boldon"}`)}
        ogType="service"
