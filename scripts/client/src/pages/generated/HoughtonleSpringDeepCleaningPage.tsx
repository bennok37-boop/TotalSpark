...
export default function HoughtonleSpringDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Houghton-le-Spring | Complete Property Restoration | Tyne & Wear";
  const pageDescription = "Professional deep cleaning in Houghton-le-Spring. Complete property restoration & spring cleaning. Serving Sunderland, Washington, Chester-le-Street & Tyne & Wear. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"houghton-le-spring"}`)}
        ogType="service"
