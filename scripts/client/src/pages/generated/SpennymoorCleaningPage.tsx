...
export default function SpennymoorCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Spennymoor | Regular & One-Off | County Durham";
  const pageDescription = "Professional cleaning services in Spennymoor. Regular domestic cleaning & one-off cleans. Serving Bishop Auckland, Durham, Ferryhill & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"spennymoor"}`)}
        ogType="service"
