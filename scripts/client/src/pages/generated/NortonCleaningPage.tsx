...
export default function NortonCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Norton | Regular & One-Off | Tees Valley";
  const pageDescription = "Professional cleaning services in Norton. Regular domestic cleaning & one-off cleans. Serving Stockton-on-Tees, Billingham & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"norton"}`)}
        ogType="service"
