...
export default function PrudhoeCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Prudhoe | Office & Business Cleaning | Northumberland";
  const pageDescription = "Professional commercial cleaning in Prudhoe. Office cleaning & business services. Serving Hexham, Corbridge, Blaydon-on-Tyne & Northumberland businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"prudhoe"}`)}
        ogType="service"
