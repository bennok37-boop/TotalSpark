...
export default function HoughtonleSpringEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Houghton-le-Spring | Deposit Back Guarantee | Tyne & Wear";
  const pageDescription = "Professional end of tenancy cleaning in Houghton-le-Spring. 100% deposit back guarantee. Serving Sunderland, Washington, Chester-le-Street & Tyne & Wear. Book online today.";
  const cityName = "Houghton-le-Spring";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"houghton-le-spring"}`)}
        ogType="service"
