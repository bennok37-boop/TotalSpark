...
export default function CrookCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Crook | Regular & One-Off | County Durham";
  const pageDescription = "Professional cleaning services in Crook. Regular domestic cleaning & one-off cleans. Serving Bishop Auckland, Spennymoor & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"crook"}`)}
        ogType="service"
