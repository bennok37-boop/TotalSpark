...
export default function BoldonDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Boldon | Complete Property Restoration | Tyne & Wear";
  const pageDescription = "Professional deep cleaning in Boldon. Complete property restoration & spring cleaning. Serving South Shields, Sunderland, Washington & Tyne & Wear. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"boldon"}`)}
        ogType="service"
