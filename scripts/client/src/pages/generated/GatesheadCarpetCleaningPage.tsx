...
export default function GatesheadCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Gateshead | Steam Cleaning Specialists | Tyne & Wear";
  const pageDescription = "Professional carpet & upholstery cleaning in Gateshead. Steam cleaning & stain removal. Serving Newcastle upon Tyne, Blaydon-on-Tyne, Felling & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"gateshead"}`)}
        ogType="service"
