...
export default function SaltburnbytheSeaEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Saltburn-by-the-Sea | Deposit Back Guarantee | Tees Valley";
  const pageDescription = "Professional end of tenancy cleaning in Saltburn-by-the-Sea. 100% deposit back guarantee. Serving Redcar, Marske-by-the-Sea, Guisborough & Tees Valley. Book online today.";
  const cityName = "Saltburn-by-the-Sea";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"saltburn-by-the-sea"}`)}
        ogType="service"
