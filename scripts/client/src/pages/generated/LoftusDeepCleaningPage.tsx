...
export default function LoftusDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Loftus | Complete Property Restoration | Tees Valley";
  const pageDescription = "Professional deep cleaning in Loftus. Complete property restoration & spring cleaning. Serving Saltburn-by-the-Sea, Easington & Tees Valley. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"loftus"}`)}
        ogType="service"
