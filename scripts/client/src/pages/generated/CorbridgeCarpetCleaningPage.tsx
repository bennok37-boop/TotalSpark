...
export default function CorbridgeCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Corbridge | Steam Cleaning Specialists | Northumberland";
  const pageDescription = "Professional carpet & upholstery cleaning in Corbridge. Steam cleaning & stain removal. Serving Hexham, Prudhoe & Northumberland. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"corbridge"}`)}
        ogType="service"
