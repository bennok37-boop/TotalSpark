...
export default function GatesheadCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Gateshead | Office & Business Cleaning | Tyne & Wear";
  const pageDescription = "Professional commercial cleaning in Gateshead. Office cleaning & business services. Serving Newcastle upon Tyne, Blaydon-on-Tyne, Felling & Tyne & Wear businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"gateshead"}`)}
        ogType="service"
