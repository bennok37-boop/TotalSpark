...
export default function WallsendDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Wallsend | Complete Property Restoration | Tyne & Wear";
  const pageDescription = "Professional deep cleaning in Wallsend. Complete property restoration & spring cleaning. Serving North Shields, Tynemouth, Longbenton & Tyne & Wear. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"wallsend"}`)}
        ogType="service"
