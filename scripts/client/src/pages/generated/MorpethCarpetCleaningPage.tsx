...
export default function MorpethCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Morpeth | Steam Cleaning Specialists | Northumberland";
  const pageDescription = "Professional carpet & upholstery cleaning in Morpeth. Steam cleaning & stain removal. Serving Ashington, Blyth, Cramlington & Northumberland. Book today.";
