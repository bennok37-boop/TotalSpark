...
export default function RyhopeEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Ryhope | Deposit Back Guarantee | Tyne & Wear";
  const pageDescription = "Professional end of tenancy cleaning in Ryhope. 100% deposit back guarantee. Serving Sunderland, Seaham, Houghton-le-Spring & Tyne & Wear. Book online today.";
  const cityName = "Ryhope";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"ryhope"}`)}
        ogType="service"
