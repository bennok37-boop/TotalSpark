...
export default function BishopAucklandCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Bishop Auckland | Regular & One-Off | County Durham";
  const pageDescription = "Professional cleaning services in Bishop Auckland. Regular domestic cleaning & one-off cleans. Serving Durham, Newton Aycliffe, Crook & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"bishop-auckland"}`)}
        ogType="service"
