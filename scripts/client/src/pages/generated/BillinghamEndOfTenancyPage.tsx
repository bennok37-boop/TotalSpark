...
export default function BillinghamEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Billingham | Deposit Back Guarantee | Tees Valley";
  const pageDescription = "Professional end of tenancy cleaning in Billingham. 100% deposit back guarantee. Serving Stockton-on-Tees, Norton & Tees Valley. Book online today.";
  const cityName = "Billingham";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"billingham"}`)}
        ogType="service"
