...
export default function MiddlesbroughDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Middlesbrough | Complete Property Restoration | Tees Valley";
  const pageDescription = "Professional deep cleaning in Middlesbrough. Complete property restoration & spring cleaning. Serving Stockton-on-Tees, Redcar, Thornaby & Tees Valley. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"middlesbrough"}`)}
        ogType="service"
