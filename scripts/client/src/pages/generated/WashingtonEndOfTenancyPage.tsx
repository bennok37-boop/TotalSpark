...
export default function WashingtonEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Washington | Deposit Back Guarantee | Tyne & Wear";
  const pageDescription = "Professional end of tenancy cleaning in Washington. 100% deposit back guarantee. Serving Sunderland, Houghton-le-Spring, Chester-le-Street & Tyne & Wear. Book online today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"washington"}`)}
        ogType="service"
