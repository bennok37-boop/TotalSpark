...
export default function GatesheadDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Gateshead | Complete Property Restoration | Tyne & Wear";
  const pageDescription = "Professional deep cleaning in Gateshead. Complete property restoration & spring cleaning. Serving Newcastle upon Tyne, Blaydon-on-Tyne, Felling & Tyne & Wear. Transform your space.";
