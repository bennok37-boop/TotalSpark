...
export default function SeahamDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Seaham | Complete Property Restoration | County Durham";
  const pageDescription = "Professional deep cleaning in Seaham. Complete property restoration & spring cleaning. Serving Sunderland, Houghton-le-Spring, Peterlee & County Durham. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"seaham"}`)}
        ogType="service"
