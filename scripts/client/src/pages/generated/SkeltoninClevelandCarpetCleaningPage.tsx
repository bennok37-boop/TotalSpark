...
export default function SkeltoninClevelandCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Skelton-in-Cleveland | Steam Cleaning Specialists | Tees Valley";
  const pageDescription = "Professional carpet & upholstery cleaning in Skelton-in-Cleveland. Steam cleaning & stain removal. Serving Guisborough, Saltburn-by-the-Sea & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"skelton-in-cleveland"}`)}
        ogType="service"
