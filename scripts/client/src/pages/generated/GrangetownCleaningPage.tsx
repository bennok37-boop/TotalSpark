...
export default function GrangetownCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Grangetown | Regular & One-Off | Tees Valley";
  const pageDescription = "Professional cleaning services in Grangetown. Regular domestic cleaning & one-off cleans. Serving Middlesbrough, Redcar, Eston & Tees Valley. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"grangetown"}`)}
        ogType="service"
