...
export default function EstonCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Eston | Office & Business Cleaning | Tees Valley";
  const pageDescription = "Professional commercial cleaning in Eston. Office cleaning & business services. Serving Middlesbrough, Redcar, Grangetown & Tees Valley businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"eston"}`)}
        ogType="service"
