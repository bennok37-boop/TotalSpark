...
export default function PeterleeCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Peterlee | Office & Business Cleaning | County Durham";
  const pageDescription = "Professional commercial cleaning in Peterlee. Office cleaning & business services. Serving Seaham, Hartlepool, Easington & County Durham businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"peterlee"}`)}
        ogType="service"
