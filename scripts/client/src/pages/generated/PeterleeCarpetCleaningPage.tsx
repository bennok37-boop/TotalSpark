...
export default function PeterleeCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Peterlee | Steam Cleaning Specialists | County Durham";
  const pageDescription = "Professional carpet & upholstery cleaning in Peterlee. Steam cleaning & stain removal. Serving Seaham, Hartlepool, Easington & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"peterlee"}`)}
        ogType="service"
