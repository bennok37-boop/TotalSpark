...
export default function RedcarCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Redcar | Office & Business Cleaning | Tees Valley";
  const pageDescription = "Professional commercial cleaning in Redcar. Office cleaning & business services. Serving Middlesbrough, Saltburn-by-the-Sea, Marske-by-the-Sea & Tees Valley businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"redcar"}`)}
        ogType="service"
