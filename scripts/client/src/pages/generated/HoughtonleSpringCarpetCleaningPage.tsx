...
export default function HoughtonleSpringCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Houghton-le-Spring | Steam Cleaning Specialists | Tyne & Wear";
  const pageDescription = "Professional carpet & upholstery cleaning in Houghton-le-Spring. Steam cleaning & stain removal. Serving Sunderland, Washington, Chester-le-Street & Tyne & Wear. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"houghton-le-spring"}`)}
        ogType="service"
