...
export default function StanleyCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Stanley | Steam Cleaning Specialists | County Durham";
  const pageDescription = "Professional carpet & upholstery cleaning in Stanley. Steam cleaning & stain removal. Serving Consett, Chester-le-Street, Durham & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"stanley"}`)}
        ogType="service"
