...
export default function HordenCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Horden | Office & Business Cleaning | County Durham";
  const pageDescription = "Professional commercial cleaning in Horden. Office cleaning & business services. Serving Peterlee, Easington, Shotton Colliery & County Durham businesses. Get quote today.";
  const cityName = "Horden";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"horden"}`)}
        ogType="service"
