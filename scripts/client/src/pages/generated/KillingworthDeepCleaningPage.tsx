...
export default function KillingworthDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Killingworth | Complete Property Restoration | Tyne & Wear";
  const pageDescription = "Professional deep cleaning in Killingworth. Complete property restoration & spring cleaning. Serving Wallsend, Longbenton, Cramlington & Tyne & Wear. Transform your space.";
