...
export default function BerwickuponTweedCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Berwick-upon-Tweed | Steam Cleaning Specialists | Northumberland";
  const pageDescription = "Professional carpet & upholstery cleaning in Berwick-upon-Tweed. Steam cleaning & stain removal. Serving Wooler & Northumberland. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"berwick-upon-tweed"}`)}
        ogType="service"
