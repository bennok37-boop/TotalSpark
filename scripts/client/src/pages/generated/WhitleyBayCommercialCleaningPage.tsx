...
export default function WhitleyBayCommercialCleaningPage() {
  ...
  const pageTitle = "Commercial Cleaning Services Whitley Bay | Office & Business Cleaning | Tyne & Wear";
  const pageDescription = "Professional commercial cleaning in Whitley Bay. Office cleaning & business services. Serving Tynemouth, North Shields, Blyth & Tyne & Wear businesses. Get quote today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"commercial-cleaning"}-${"whitley-bay"}`)}
        ogType="service"
