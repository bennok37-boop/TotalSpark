...
export default function WashingtonDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Washington | Complete Property Restoration | Tyne & Wear";
  const pageDescription = "Professional deep cleaning in Washington. Complete property restoration & spring cleaning. Serving Sunderland, Houghton-le-Spring, Chester-le-Street & Tyne & Wear. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"washington"}`)}
        ogType="service"
