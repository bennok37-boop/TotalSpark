...
export default function BerwickuponTweedCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Berwick-upon-Tweed | Regular & One-Off | Northumberland";
  const pageDescription = "Professional cleaning services in Berwick-upon-Tweed. Regular domestic cleaning & one-off cleans. Serving Wooler & Northumberland. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"berwick-upon-tweed"}`)}
        ogType="service"
