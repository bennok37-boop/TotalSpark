...
export default function YarmCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Yarm | Steam Cleaning Specialists | Tees Valley";
  const pageDescription = "Professional carpet & upholstery cleaning in Yarm. Steam cleaning & stain removal. Serving Stockton-on-Tees, Ingleby Barwick, Eaglescliffe & Tees Valley. Book today.";
  const cityName = "Yarm";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"yarm"}`)}
        ogType="service"
