...
export default function ChesterleStreetCarpetCleaningPage() {
  ...
  const pageTitle = "Carpet & Upholstery Cleaning Chester-le-Street | Steam Cleaning Specialists | County Durham";
  const pageDescription = "Professional carpet & upholstery cleaning in Chester-le-Street. Steam cleaning & stain removal. Serving Durham, Washington, Stanley & County Durham. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"carpet-cleaning"}-${"chester-le-street"}`)}
        ogType="service"
