...
export default function AmbleCleaningPage() {
  ...
  const pageTitle = "Professional Cleaning Services Amble | Regular & One-Off | Northumberland";
  const pageDescription = "Professional cleaning services in Amble. Regular domestic cleaning & one-off cleans. Serving Alnwick, Seahouses & Northumberland. Book today.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"cleaning"}-${"amble"}`)}
        ogType="service"
