...
export default function ChesterleStreetEndOfTenancyPage() {
  ...
  const pageTitle = "End of Tenancy Cleaning Chester-le-Street | Deposit Back Guarantee | County Durham";
  const pageDescription = "Professional end of tenancy cleaning in Chester-le-Street. 100% deposit back guarantee. Serving Durham, Washington, Stanley & County Durham. Book online today.";
  const cityName = "Chester-le-Street";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"end-of-tenancy"}-${"chester-le-street"}`)}
        ogType="service"
