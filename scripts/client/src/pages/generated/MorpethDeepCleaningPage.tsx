...
export default function MorpethDeepCleaningPage() {
  ...
  const pageTitle = "Deep Cleaning Services Morpeth | Complete Property Restoration | Northumberland";
  const pageDescription = "Professional deep cleaning in Morpeth. Complete property restoration & spring cleaning. Serving Ashington, Blyth, Cramlington & Northumberland. Transform your space.";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        canonicalUrl={createCanonicalUrl(`/${"deep-cleaning"}-${"morpeth"}`)}
        ogType="service"
